# Build Hero With Text And Two Button in BuilderStudio

> Build this component in our Agentic IDE: [BuilderStudio](https://builderstudio.dev).
>
> Join the BuilderStudio community on [Discord](https://discord.gg/QdWeSGCqfe) and [Reddit](https://reddit.com/r/builderstudio).

![Hero With Text And Two Button screenshot](screenshot.png)

## Component

- Author group: `tommyjepsen`
- Component: `hero-with-text-and-two-button`
- Variant: `default`
...
- Author: tommyjepsen
- Component slug: hero-with-text-and-two-button
- Demo slug: default
- Title: hero-with-text-and-two-button
- Description: 
