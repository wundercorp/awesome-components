...
- Source page: https://21st.dev/community/components/ravikatiyar/workflow-builder-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/workflow-builder-card
- Author: ravikatiyar
- Component slug: workflow-builder-card
- Demo slug: default
- Title: workflow-builder-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/workflow-builder-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__workflow-builder-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__workflow-builder-card__default.png
