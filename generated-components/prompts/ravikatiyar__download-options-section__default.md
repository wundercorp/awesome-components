...
- Source page: https://21st.dev/community/components/ravikatiyar/download-options-section/default
- Registry URL: https://21st.dev/r/ravikatiyar/download-options-section
- Author: ravikatiyar
- Component slug: download-options-section
- Demo slug: default
- Title: download-options-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/download-options-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__download-options-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__download-options-section__default.png
