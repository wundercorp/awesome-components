...
- Source page: https://21st.dev/community/components/kavikatiyar/tracker-card/default
- Registry URL: https://21st.dev/r/kavikatiyar/tracker-card
- Author: kavikatiyar
- Component slug: tracker-card
- Demo slug: default
- Title: tracker-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/tracker-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__tracker-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__tracker-card__default.png
