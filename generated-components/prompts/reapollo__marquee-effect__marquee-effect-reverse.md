...
- Source page: https://21st.dev/community/components/reapollo/marquee-effect/marquee-effect-reverse
- Registry URL: https://21st.dev/r/reapollo/marquee-effect
- Author: reapollo
- Component slug: marquee-effect
- Demo slug: marquee-effect-reverse
- Title: marquee-effect
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/marquee-effect with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__marquee-effect__marquee-effect-reverse.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__marquee-effect__marquee-effect-reverse.png
