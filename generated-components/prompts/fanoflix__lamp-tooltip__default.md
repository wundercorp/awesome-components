...
- Source page: https://21st.dev/community/components/fanoflix/lamp-tooltip/default
- Registry URL: https://21st.dev/r/fanoflix/lamp-tooltip
- Author: fanoflix
- Component slug: lamp-tooltip
- Demo slug: default
- Title: lamp-tooltip
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/fanoflix/lamp-tooltip with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/fanoflix__lamp-tooltip__default.html
- Local screenshot file: generated-21st-prompts/screenshots/fanoflix__lamp-tooltip__default.png
