...
- Source page: https://21st.dev/community/components/rafa-porto/sign-in/default
- Registry URL: https://21st.dev/r/rafa-porto/sign-in
- Author: rafa-porto
- Component slug: sign-in
- Demo slug: default
- Title: sign-in
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/rafa-porto/sign-in with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/rafa-porto__sign-in__default.html
- Local screenshot file: generated-21st-prompts/screenshots/rafa-porto__sign-in__default.png
