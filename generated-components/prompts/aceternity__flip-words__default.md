...
- Source page: https://21st.dev/community/components/aceternity/flip-words/default
- Registry URL: https://21st.dev/r/aceternity/flip-words
- Author: aceternity
- Component slug: flip-words
- Demo slug: default
- Title: flip-words
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/flip-words with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__flip-words__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__flip-words__default.png
