...
- Source page: https://21st.dev/community/components/efferd/navigation-menu/default
- Registry URL: https://21st.dev/r/efferd/navigation-menu
- Author: efferd
- Component slug: navigation-menu
- Demo slug: default
- Title: navigation-menu
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/efferd/navigation-menu with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/efferd__navigation-menu__default.html
- Local screenshot file: generated-21st-prompts/screenshots/efferd__navigation-menu__default.png
