...
- Source page: https://21st.dev/community/components/samhimself/feedback-prompt/default
- Registry URL: https://21st.dev/r/samhimself/feedback-prompt
- Author: samhimself
- Component slug: feedback-prompt
- Demo slug: default
- Title: feedback-prompt
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/samhimself/feedback-prompt with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/samhimself__feedback-prompt__default.html
- Local screenshot file: generated-21st-prompts/screenshots/samhimself__feedback-prompt__default.png
