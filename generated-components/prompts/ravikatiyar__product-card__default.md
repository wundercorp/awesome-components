...
- Source page: https://21st.dev/community/components/ravikatiyar/product-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/product-card
- Author: ravikatiyar
- Component slug: product-card
- Demo slug: default
- Title: product-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/product-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__product-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__product-card__default.png
