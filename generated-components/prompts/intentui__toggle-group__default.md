...
- Source page: https://21st.dev/community/components/intentui/toggle-group/default
- Registry URL: https://21st.dev/r/intentui/toggle-group
- Author: intentui
- Component slug: toggle-group
- Demo slug: default
- Title: toggle-group
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/intentui/toggle-group with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/intentui__toggle-group__default.html
- Local screenshot file: generated-21st-prompts/screenshots/intentui__toggle-group__default.png
