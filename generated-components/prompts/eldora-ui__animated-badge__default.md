...
- Source page: https://21st.dev/community/components/eldora-ui/animated-badge/default
- Registry URL: https://21st.dev/r/eldora-ui/animated-badge
- Author: eldora-ui
- Component slug: animated-badge
- Demo slug: default
- Title: animated-badge
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/eldora-ui/animated-badge with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/eldora-ui__animated-badge__default.html
- Local screenshot file: generated-21st-prompts/screenshots/eldora-ui__animated-badge__default.png
