...
- Source page: https://21st.dev/community/components/edwinvakayil/the-dialog/default
- Registry URL: https://21st.dev/r/edwinvakayil/the-dialog
- Author: edwinvakayil
- Component slug: the-dialog
- Demo slug: default
- Title: the-dialog
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/the-dialog with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__the-dialog__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__the-dialog__default.png
