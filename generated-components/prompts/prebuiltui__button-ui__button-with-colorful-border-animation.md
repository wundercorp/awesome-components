...
- Source page: https://21st.dev/community/components/prebuiltui/button-ui/button-with-colorful-border-animation
- Registry URL: https://21st.dev/r/prebuiltui/button-ui
- Author: prebuiltui
- Component slug: button-ui
- Demo slug: button-with-colorful-border-animation
- Title: button-ui
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/prebuiltui__button-ui__button-with-colorful-border-animation.html
- Local screenshot file: generated-21st-prompts/screenshots/prebuiltui__button-ui__button-with-colorful-border-animation.png
