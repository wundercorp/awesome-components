...
- Source page: https://21st.dev/community/components/ravikatiyar/photo-stack/default
- Registry URL: https://21st.dev/r/ravikatiyar/photo-stack
- Author: ravikatiyar
- Component slug: photo-stack
- Demo slug: default
- Title: photo-stack
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/photo-stack with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__photo-stack__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__photo-stack__default.png
