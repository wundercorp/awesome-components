...
- Source page: https://21st.dev/community/components/forge-ui/security-card/default
- Registry URL: https://21st.dev/r/forge-ui/security-card
- Author: forge-ui
- Component slug: security-card
- Demo slug: default
- Title: security-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/forge-ui/security-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/forge-ui__security-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/forge-ui__security-card__default.png
