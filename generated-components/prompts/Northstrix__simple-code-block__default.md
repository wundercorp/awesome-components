...
- Source page: https://21st.dev/community/components/Northstrix/simple-code-block/default
- Registry URL: https://21st.dev/r/Northstrix/simple-code-block
- Author: Northstrix
- Component slug: simple-code-block
- Demo slug: default
- Title: simple-code-block
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Northstrix/simple-code-block with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Northstrix__simple-code-block__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Northstrix__simple-code-block__default.png
