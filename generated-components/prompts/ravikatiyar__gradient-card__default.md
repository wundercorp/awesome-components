...
- Source page: https://21st.dev/community/components/ravikatiyar/gradient-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/gradient-card
- Author: ravikatiyar
- Component slug: gradient-card
- Demo slug: default
- Title: gradient-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/gradient-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__gradient-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__gradient-card__default.png
