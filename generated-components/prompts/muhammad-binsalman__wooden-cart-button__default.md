...
- Source page: https://21st.dev/community/components/muhammad-binsalman/wooden-cart-button/default
- Registry URL: https://21st.dev/r/muhammad-binsalman/wooden-cart-button
- Author: muhammad-binsalman
- Component slug: wooden-cart-button
- Demo slug: default
- Title: wooden-cart-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/muhammad-binsalman/wooden-cart-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/muhammad-binsalman__wooden-cart-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/muhammad-binsalman__wooden-cart-button__default.png
