...
- Source page: https://21st.dev/community/components/shadcnspace/toggle-theme/default
- Registry URL: https://21st.dev/r/shadcnspace/toggle-theme
- Author: shadcnspace
- Component slug: toggle-theme
- Demo slug: default
- Title: toggle-theme
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcnspace/toggle-theme with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcnspace__toggle-theme__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcnspace__toggle-theme__default.png
