...
- Source page: https://21st.dev/community/components/ui-layouts/scroll-card/default
- Registry URL: https://21st.dev/r/ui-layouts/scroll-card
- Author: ui-layouts
- Component slug: scroll-card
- Demo slug: default
- Title: scroll-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/scroll-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__scroll-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__scroll-card__default.png
