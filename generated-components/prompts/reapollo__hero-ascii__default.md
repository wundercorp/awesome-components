...
- Source page: https://21st.dev/community/components/reapollo/hero-ascii/default
- Registry URL: https://21st.dev/r/reapollo/hero-ascii
- Author: reapollo
- Component slug: hero-ascii
- Demo slug: default
- Title: hero-ascii
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/hero-ascii with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__hero-ascii__default.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__hero-ascii__default.png
