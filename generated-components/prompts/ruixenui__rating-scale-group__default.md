...
- Source page: https://21st.dev/community/components/ruixenui/rating-scale-group/default
- Registry URL: https://21st.dev/r/ruixenui/rating-scale-group
- Author: ruixenui
- Component slug: rating-scale-group
- Demo slug: default
- Title: rating-scale-group
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/rating-scale-group with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__rating-scale-group__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__rating-scale-group__default.png
