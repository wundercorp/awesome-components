...
- Source page: https://21st.dev/community/components/ravikatiyar/order-status-tracker/default
- Registry URL: https://21st.dev/r/ravikatiyar/order-status-tracker
- Author: ravikatiyar
- Component slug: order-status-tracker
- Demo slug: default
- Title: order-status-tracker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/order-status-tracker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__order-status-tracker__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__order-status-tracker__default.png
