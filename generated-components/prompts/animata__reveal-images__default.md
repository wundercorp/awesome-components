...
- Source page: https://21st.dev/community/components/animata/reveal-images/default
- Registry URL: https://21st.dev/r/animata/reveal-images
- Author: animata
- Component slug: reveal-images
- Demo slug: default
- Title: reveal-images
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/animata/reveal-images with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/animata__reveal-images__default.html
- Local screenshot file: generated-21st-prompts/screenshots/animata__reveal-images__default.png
