...
- Source page: https://21st.dev/community/components/ravikatiyar/activity-chart-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/activity-chart-card
- Author: ravikatiyar
- Component slug: activity-chart-card
- Demo slug: default
- Title: activity-chart-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/activity-chart-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__activity-chart-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__activity-chart-card__default.png
