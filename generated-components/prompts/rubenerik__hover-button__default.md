...
- Source page: https://21st.dev/community/components/rubenerik/hover-button/default
- Registry URL: https://21st.dev/r/rubenerik/hover-button
- Author: rubenerik
- Component slug: hover-button
- Demo slug: default
- Title: hover-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/rubenerik/hover-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/rubenerik__hover-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/rubenerik__hover-button__default.png
