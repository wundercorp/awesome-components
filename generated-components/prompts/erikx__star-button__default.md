...
- Source page: https://21st.dev/community/components/erikx/star-button/default
- Registry URL: https://21st.dev/r/erikx/star-button
- Author: erikx
- Component slug: star-button
- Demo slug: default
- Title: star-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/star-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__star-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__star-button__default.png
