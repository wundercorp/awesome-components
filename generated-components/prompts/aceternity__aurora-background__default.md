...
- Source page: https://21st.dev/community/components/aceternity/aurora-background/default
- Registry URL: https://21st.dev/r/aceternity/aurora-background
- Author: aceternity
- Component slug: aurora-background
- Demo slug: default
- Title: aurora-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/aurora-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__aurora-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__aurora-background__default.png
