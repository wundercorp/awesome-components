...
- Source page: https://21st.dev/community/components/Edil-ozi/custom-checkbox/default
- Registry URL: https://21st.dev/r/Edil-ozi/custom-checkbox
- Author: Edil-ozi
- Component slug: custom-checkbox
- Demo slug: default
- Title: custom-checkbox
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Edil-ozi/custom-checkbox with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Edil-ozi__custom-checkbox__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Edil-ozi__custom-checkbox__default.png
