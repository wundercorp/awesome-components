...
- Source page: https://21st.dev/community/components/ravikatiyar/registration-stepper/default
- Registry URL: https://21st.dev/r/ravikatiyar/registration-stepper
- Author: ravikatiyar
- Component slug: registration-stepper
- Demo slug: default
- Title: registration-stepper
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/registration-stepper with status 500. Error: {"error":"\nInvalid `prisma.registry.findUnique()` invocation:\n\n\nTimed out fetching a new connection from the connection pool. More info: http://pris.ly/d/connection-pool (Current connection pool timeout: 10, connection limit: 3)"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__registration-stepper__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__registration-stepper__default.png
