...
- Source page: https://21st.dev/community/components/aliimam/highlighter/default
- Registry URL: https://21st.dev/r/aliimam/highlighter
- Author: aliimam
- Component slug: highlighter
- Demo slug: default
- Title: highlighter
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/highlighter with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__highlighter__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__highlighter__default.png
