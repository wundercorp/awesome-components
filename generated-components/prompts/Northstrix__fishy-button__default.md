...
- Source page: https://21st.dev/community/components/Northstrix/fishy-button/default
- Registry URL: https://21st.dev/r/Northstrix/fishy-button
- Author: Northstrix
- Component slug: fishy-button
- Demo slug: default
- Title: fishy-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Northstrix/fishy-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Northstrix__fishy-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Northstrix__fishy-button__default.png
...
```html
<div id="root"><div class="fixed top-4 left-4 z-10"><select class="appearance-none h-8 max-w-[200px] text-sm leading-tight rounded-lg pl-3 pr-7 py-0 border bg-background focus:outline-none focus:ring-0"><option value="named_DemoFishyButton_DemoFishyButton">DemoFishyButton</option></select><div class="absolute top-1/2 transform -translate-y-1/2 right-2 pointer-events-none"><svg class="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M5.516 7.548c.436-.446 1.043-.48 1.576 0L10 10.405l2.908-2.857c.533-.48 1.14-.446 1.576 0 .436.445.408 1.197 0 1.615l-3.734 3.705c-.533.534-1.39.534-1.923 0l-3.734-3.705c-.408-.418-.436-1.17 0-1.615z"></path></svg></div></div><div class="w-screen min-h-screen flex justify-center items-center"><div class="flex flex-col gap-8 w-full"><div class="flex flex-wrap items-center justify-center gap-6 w-full"><button type="button" class="button  button--1 fish-speed-egnjgk" style="border-radius: 20px; width: 140px; height: 53px;"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="fish"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><span class="button__text">Ekhad</span><style>
.fish-speed-egnjgk:hover .fish {
  animation: fish ease 2.3s forwards;
  opacity: 1;
}
</style><style>
.button--1 {
...
@keyframes encrypted-space-wave_4 {
  ...
  100% { clip-path: path('M128.53,0c-13.22,12-19.04,5.96-27.62,4.3-12.9-2.5-14.51,2.69-29.7,10.84-8.75,4.7-15.33,2.81-28.21-.3-15.44-3.72-19.2,7.95-29.03,11.04C4.72,28.8,.76,37.83,0,43.72H128.53V0Z'); }
      ...
      </style></button><button type="button" class="button  button--2 fish-speed-tlonp9" style="border-radius: 4px; width: 140px; height: 53px;"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="fish"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><span class="button__text">Two</span><style>
.fish-speed-tlonp9:hover .fish {
  animation: fish ease 1.9s forwards;
  opacity: 1;
}
</style><style>
.button--1 {
...
@keyframes encrypted-space-wave_4 {
  ...
  100% { clip-path: path('M128.53,0c-13.22,12-19.04,5.96-27.62,4.3-12.9-2.5-14.51,2.69-29.7,10.84-8.75,4.7-15.33,2.81-28.21-.3-15.44-3.72-19.2,7.95-29.03,11.04C4.72,28.8,.76,37.83,0,43.72H128.53V0Z'); }
      ...
      </style></button><button type="button" class="button  button--3 fish-speed-5dgcxo" style="border-radius: 20px; width: 140px; height: 53px;"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="fish"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><span class="button__text">שלוש</span><style>
.fish-speed-5dgcxo:hover .fish {
  animation: fish ease 2.3s forwards;
  opacity: 1;
}
</style><style>
...
@keyframes encrypted-space-wave_4 {
  ...
  100% { clip-path: path('M128.53,0c-13.22,12-19.04,5.96-27.62,4.3-12.9-2.5-14.51,2.69-29.7,10.84-8.75,4.7-15.33,2.81-28.21-.3-15.44-3.72-19.2,7.95-29.03,11.04C4.72,28.8,.76,37.83,0,43.72H128.53V0Z'); }
      ...
      </style></button></div><div class="flex flex-wrap items-center justify-center gap-6 w-full"><button type="button" class="button  button--1 fish-speed-dg2ntg" style="font-family: &quot;Roboto Mono&quot;, monospace; border-radius: 40px; width: 272px; height: 53px;"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="fish"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><span class="button__text" style="font-family: &quot;Roboto Mono&quot;, monospace;">Roboto Mono</span><style>
.fish-speed-dg2ntg:hover .fish {
  animation: fish ease 2.3s forwards;
  opacity: 1;
}
</style><style>
...
@keyframes encrypted-space-wave_4 {
  ...
  100% { clip-path: path('M128.53,0c-13.22,12-19.04,5.96-27.62,4.3-12.9-2.5-14.51,2.69-29.7,10.84-8.75,4.7-15.33,2.81-28.21-.3-15.44-3.72-19.2,7.95-29.03,11.04C4.72,28.8,.76,37.83,0,43.72H128.53V0Z'); }
      ...
      </style></button><button type="button" class="button  button--2 fish-speed-0dqf7w" style="font-family: Impact, fantasy, sans-serif; border-radius: 10px; width: 272px; height: 53px;"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="fish"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><div class="bubble"></div><span class="button__text" style="font-family: Impact, fantasy, sans-serif;">Impact Bold</span><style>
.fish-speed-0dqf7w:hover .fish {
  animation: fish ease 2.3s forwards;
  opacity: 1;
}
</style><style>
...
[TRUNCATED: original length 83876 characters]
```
