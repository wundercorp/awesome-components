...
- Source page: https://21st.dev/community/components/shadway/background-shader/default
- Registry URL: https://21st.dev/r/shadway/background-shader
- Author: shadway
- Component slug: background-shader
- Demo slug: default
- Title: background-shader
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadway/background-shader with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadway__background-shader__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadway__background-shader__default.png
