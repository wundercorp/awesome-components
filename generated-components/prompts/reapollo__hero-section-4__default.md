...
- Source page: https://21st.dev/community/components/reapollo/hero-section-4/default
- Registry URL: https://21st.dev/r/reapollo/hero-section-4
- Author: reapollo
- Component slug: hero-section-4
- Demo slug: default
- Title: hero-section-4
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/hero-section-4 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__hero-section-4__default.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__hero-section-4__default.png
