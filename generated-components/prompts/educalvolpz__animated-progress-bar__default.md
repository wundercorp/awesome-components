...
- Source page: https://21st.dev/community/components/educalvolpz/animated-progress-bar/default
- Registry URL: https://21st.dev/r/educalvolpz/animated-progress-bar
- Author: educalvolpz
- Component slug: animated-progress-bar
- Demo slug: default
- Title: animated-progress-bar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/educalvolpz/animated-progress-bar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/educalvolpz__animated-progress-bar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/educalvolpz__animated-progress-bar__default.png
