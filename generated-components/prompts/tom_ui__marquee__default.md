...
- Source page: https://21st.dev/community/components/tom_ui/marquee/default
- Registry URL: https://21st.dev/r/tom_ui/marquee
- Author: tom_ui
- Component slug: marquee
- Demo slug: default
- Title: marquee
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tom_ui/marquee with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tom_ui__marquee__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tom_ui__marquee__default.png
