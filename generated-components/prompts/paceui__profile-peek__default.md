...
- Source page: https://21st.dev/community/components/paceui/profile-peek/default
- Registry URL: https://21st.dev/r/paceui/profile-peek
- Author: paceui
- Component slug: profile-peek
- Demo slug: default
- Title: profile-peek
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/paceui/profile-peek with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/paceui__profile-peek__default.html
- Local screenshot file: generated-21st-prompts/screenshots/paceui__profile-peek__default.png
