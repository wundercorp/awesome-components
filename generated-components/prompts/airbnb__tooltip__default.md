...
- Source page: https://21st.dev/community/components/airbnb/tooltip/default
- Registry URL: https://21st.dev/r/airbnb/tooltip
- Author: airbnb
- Component slug: tooltip
- Demo slug: default
- Title: tooltip
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/airbnb/tooltip with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/airbnb__tooltip__default.html
- Local screenshot file: generated-21st-prompts/screenshots/airbnb__tooltip__default.png
