...
- Source page: https://21st.dev/community/components/ui-layouts/clipped-image/default
- Registry URL: https://21st.dev/r/ui-layouts/clipped-image
- Author: ui-layouts
- Component slug: clipped-image
- Demo slug: default
- Title: clipped-image
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/clipped-image with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__clipped-image__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__clipped-image__default.png
