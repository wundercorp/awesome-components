...
- Source page: https://21st.dev/community/components/dailydischq/email-categories/default
- Registry URL: https://21st.dev/r/dailydischq/email-categories
- Author: dailydischq
- Component slug: email-categories
- Demo slug: default
- Title: email-categories
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dailydischq/email-categories with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dailydischq__email-categories__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dailydischq__email-categories__default.png
