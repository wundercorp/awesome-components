...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/full-width
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__full-width.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__full-width.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="w-[400px] space-y-4"><style>
    ...
    </style><div class="color-field color-field--full-width" data-slot="color-field" data-full-width="true"><label class="label" data-slot="label" for="_r_1_">Theme Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_1_" inputmode="text" spellcheck="false" type="text" value="#8B5CF6" name="color-with-suffix"></div></div></div></div></div>
```
