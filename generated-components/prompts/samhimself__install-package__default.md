...
- Source page: https://21st.dev/community/components/samhimself/install-package/default
- Registry URL: https://21st.dev/r/samhimself/install-package
- Author: samhimself
- Component slug: install-package
- Demo slug: default
- Title: install-package
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/samhimself/install-package with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/samhimself__install-package__default.html
- Local screenshot file: generated-21st-prompts/screenshots/samhimself__install-package__default.png
