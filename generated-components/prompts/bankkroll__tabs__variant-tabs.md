...
- Source page: https://21st.dev/community/components/bankkroll/tabs/variant-tabs
- Registry URL: https://21st.dev/r/bankkroll/tabs
- Author: bankkroll
- Component slug: tabs
- Demo slug: variant-tabs
- Title: tabs
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/bankkroll/tabs with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/bankkroll__tabs__variant-tabs.html
- Local screenshot file: generated-21st-prompts/screenshots/bankkroll__tabs__variant-tabs.png
