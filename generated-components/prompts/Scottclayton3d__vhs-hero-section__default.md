...
- Source page: https://21st.dev/community/components/Scottclayton3d/vhs-hero-section/default
- Registry URL: https://21st.dev/r/Scottclayton3d/vhs-hero-section
- Author: Scottclayton3d
- Component slug: vhs-hero-section
- Demo slug: default
- Title: vhs-hero-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Scottclayton3d/vhs-hero-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Scottclayton3d__vhs-hero-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Scottclayton3d__vhs-hero-section__default.png
