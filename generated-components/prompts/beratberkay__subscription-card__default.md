...
- Source page: https://21st.dev/community/components/beratberkay/subscription-card/default
- Registry URL: https://21st.dev/r/beratberkay/subscription-card
- Author: beratberkay
- Component slug: subscription-card
- Demo slug: default
- Title: subscription-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/beratberkay/subscription-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/beratberkay__subscription-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/beratberkay__subscription-card__default.png
