...
- Source page: https://21st.dev/community/components/kinfe123/bento/default
- Registry URL: https://21st.dev/r/kinfe123/bento
- Author: kinfe123
- Component slug: bento
- Demo slug: default
- Title: bento
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kinfe123/bento with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kinfe123__bento__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kinfe123__bento__default.png
