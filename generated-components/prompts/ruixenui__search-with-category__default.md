...
- Source page: https://21st.dev/community/components/ruixenui/search-with-category/default
- Registry URL: https://21st.dev/r/ruixenui/search-with-category
- Author: ruixenui
- Component slug: search-with-category
- Demo slug: default
- Title: search-with-category
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/search-with-category with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__search-with-category__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__search-with-category__default.png
