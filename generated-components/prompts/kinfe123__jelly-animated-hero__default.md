...
- Source page: https://21st.dev/community/components/kinfe123/jelly-animated-hero/default
- Registry URL: https://21st.dev/r/kinfe123/jelly-animated-hero
- Author: kinfe123
- Component slug: jelly-animated-hero
- Demo slug: default
- Title: jelly-animated-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kinfe123/jelly-animated-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kinfe123__jelly-animated-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kinfe123__jelly-animated-hero__default.png
