...
- Source page: https://21st.dev/community/components/jatin-yadav05/lets-work-section/default
- Registry URL: https://21st.dev/r/jatin-yadav05/lets-work-section
- Author: jatin-yadav05
- Component slug: lets-work-section
- Demo slug: default
- Title: lets-work-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jatin-yadav05/lets-work-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jatin-yadav05__lets-work-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jatin-yadav05__lets-work-section__default.png
