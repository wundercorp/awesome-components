...
- Source page: https://21st.dev/community/components/educalvolpz/pricing-blocks/creative-pricing
- Registry URL: https://21st.dev/r/educalvolpz/pricing-blocks
- Author: educalvolpz
- Component slug: pricing-blocks
- Demo slug: creative-pricing
- Title: pricing-blocks
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/educalvolpz/pricing-blocks with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/educalvolpz__pricing-blocks__creative-pricing.html
- Local screenshot file: generated-21st-prompts/screenshots/educalvolpz__pricing-blocks__creative-pricing.png
