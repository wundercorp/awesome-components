...
- Source page: https://21st.dev/community/components/educalvolpz/accordion-1/default
- Registry URL: https://21st.dev/r/educalvolpz/accordion-1
- Author: educalvolpz
- Component slug: accordion-1
- Demo slug: default
- Title: accordion-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/educalvolpz/accordion-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/educalvolpz__accordion-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/educalvolpz__accordion-1__default.png
