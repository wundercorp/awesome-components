...
- Source page: https://21st.dev/community/components/hero_ui/heroui-description/default
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-description__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-description__default.png
...
</style><div class="heroui-description-field"><label class="label heroui-description-label" for="email">Email</label><input class="input input--primary heroui-description-input heroui-description-input-wide" aria-describedby="email-description" id="email" placeholder="you@example.com" type="email"><span class="description heroui-description-description" data-slot="description" slot="description" id="email-description">We'll never share your email with anyone else.</span></div></div></div>
```
