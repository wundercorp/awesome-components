...
- Source page: https://21st.dev/community/components/wisedev/image-auto-slider/default
- Registry URL: https://21st.dev/r/wisedev/image-auto-slider
- Author: wisedev
- Component slug: image-auto-slider
- Demo slug: default
- Title: image-auto-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/wisedev/image-auto-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/wisedev__image-auto-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/wisedev__image-auto-slider__default.png
