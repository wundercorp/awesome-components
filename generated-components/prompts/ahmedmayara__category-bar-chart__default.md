...
- Source page: https://21st.dev/community/components/ahmedmayara/category-bar-chart/default
- Registry URL: https://21st.dev/r/ahmedmayara/category-bar-chart
- Author: ahmedmayara
- Component slug: category-bar-chart
- Demo slug: default
- Title: category-bar-chart
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ahmedmayara/category-bar-chart with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ahmedmayara__category-bar-chart__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ahmedmayara__category-bar-chart__default.png
