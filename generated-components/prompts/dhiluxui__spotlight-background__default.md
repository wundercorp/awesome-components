...
- Source page: https://21st.dev/community/components/dhiluxui/spotlight-background/default
- Registry URL: https://21st.dev/r/dhiluxui/spotlight-background
- Author: dhiluxui
- Component slug: spotlight-background
- Demo slug: default
- Title: spotlight-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/spotlight-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__spotlight-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__spotlight-background__default.png
