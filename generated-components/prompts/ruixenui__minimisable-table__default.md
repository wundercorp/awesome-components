...
- Source page: https://21st.dev/community/components/ruixenui/minimisable-table/default
- Registry URL: https://21st.dev/r/ruixenui/minimisable-table
- Author: ruixenui
- Component slug: minimisable-table
- Demo slug: default
- Title: minimisable-table
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/minimisable-table with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__minimisable-table__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__minimisable-table__default.png
