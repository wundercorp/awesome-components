...
- Source page: https://21st.dev/community/components/uimix/processing-card/default
- Registry URL: https://21st.dev/r/uimix/processing-card
- Author: uimix
- Component slug: processing-card
- Demo slug: default
- Title: processing-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uimix/processing-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uimix__processing-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uimix__processing-card__default.png
