...
- Source page: https://21st.dev/community/components/samitkapoor/circle-menu/default
- Registry URL: https://21st.dev/r/samitkapoor/circle-menu
- Author: samitkapoor
- Component slug: circle-menu
- Demo slug: default
- Title: circle-menu
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/samitkapoor/circle-menu with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/samitkapoor__circle-menu__default.html
- Local screenshot file: generated-21st-prompts/screenshots/samitkapoor__circle-menu__default.png
