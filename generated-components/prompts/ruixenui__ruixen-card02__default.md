...
- Source page: https://21st.dev/community/components/ruixenui/ruixen-card02/default
- Registry URL: https://21st.dev/r/ruixenui/ruixen-card02
- Author: ruixenui
- Component slug: ruixen-card02
- Demo slug: default
- Title: ruixen-card02
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/ruixen-card02 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__ruixen-card02__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__ruixen-card02__default.png
