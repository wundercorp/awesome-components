...
- Source page: https://21st.dev/community/components/danielpetho/underline-to-background/default
- Registry URL: https://21st.dev/r/danielpetho/underline-to-background
- Author: danielpetho
- Component slug: underline-to-background
- Demo slug: default
- Title: underline-to-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/underline-to-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__underline-to-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__underline-to-background__default.png
