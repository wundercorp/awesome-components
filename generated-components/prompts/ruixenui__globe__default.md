...
- Source page: https://21st.dev/community/components/ruixenui/globe/default
- Registry URL: https://21st.dev/r/ruixenui/globe
- Author: ruixenui
- Component slug: globe
- Demo slug: default
- Title: globe
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/globe with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__globe__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__globe__default.png
