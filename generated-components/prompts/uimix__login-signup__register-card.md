...
- Source page: https://21st.dev/community/components/uimix/login-signup/register-card
- Registry URL: https://21st.dev/r/uimix/login-signup
- Author: uimix
- Component slug: login-signup
- Demo slug: register-card
- Title: login-signup
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/uimix__login-signup__register-card.html
- Local screenshot file: generated-21st-prompts/screenshots/uimix__login-signup__register-card.png
