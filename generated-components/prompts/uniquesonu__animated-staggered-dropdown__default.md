...
- Source page: https://21st.dev/community/components/uniquesonu/animated-staggered-dropdown/default
- Registry URL: https://21st.dev/r/uniquesonu/animated-staggered-dropdown
- Author: uniquesonu
- Component slug: animated-staggered-dropdown
- Demo slug: default
- Title: animated-staggered-dropdown
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/animated-staggered-dropdown with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__animated-staggered-dropdown__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__animated-staggered-dropdown__default.png
