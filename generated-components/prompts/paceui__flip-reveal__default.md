...
- Source page: https://21st.dev/community/components/paceui/flip-reveal/default
- Registry URL: https://21st.dev/r/paceui/flip-reveal
- Author: paceui
- Component slug: flip-reveal
- Demo slug: default
- Title: flip-reveal
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/paceui/flip-reveal with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/paceui__flip-reveal__default.html
- Local screenshot file: generated-21st-prompts/screenshots/paceui__flip-reveal__default.png
