...
- Source page: https://21st.dev/community/components/shugar/drawer/default
- Registry URL: https://21st.dev/r/shugar/drawer
- Author: shugar
- Component slug: drawer
- Demo slug: default
- Title: drawer
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/drawer with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__drawer__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__drawer__default.png
