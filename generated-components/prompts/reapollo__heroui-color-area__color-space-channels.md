...
- Source page: https://21st.dev/community/components/reapollo/heroui-color-area/color-space-channels
- Registry URL: https://21st.dev/r/reapollo/heroui-color-area
- Author: reapollo
- Component slug: heroui-color-area
- Demo slug: color-space-channels
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__heroui-color-area__color-space-channels.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__heroui-color-area__color-space-channels.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col items-center gap-6"><div class="flex gap-4"><label class="select select--primary w-32"><span class="label" data-slot="label">Color Space</span><select aria-label="Color Space" class="select__trigger"><option value="rgb">RGB</option><option value="hsl">HSL</option><option value="hsb">HSB</option></select></label><label class="select select--primary w-36"><span class="label" data-slot="label">X Axis</span><select aria-label="X Axis" class="select__trigger"><option value="hue">Hue</option><option value="saturation">Saturation</option></select></label><label class="select select--primary w-36"><span class="label" data-slot="label">Y Axis</span><select aria-label="Y Axis" class="select__trigger"><option value="hue">Hue</option><option value="brightness">Brightness</option></select></label></div><style>
    ...
    </style><div role="group" tabindex="0" aria-label="Color area" data-slot="color-area" class="color-area" style="--color-area-background: linear-gradient(to top, black, transparent), linear-gradient(to right, white, hsl(219, 100%, 50%));"><div data-slot="color-area-thumb" class="color-area__thumb" style="--color-area-thumb-color: rgba(100, 148, 237, 1); left: 58%; top: 7%;"></div></div><div class="flex items-center gap-3"><div class="size-8 rounded-md border border-default" style="background-color: rgb(100, 148, 237);"></div><code class="rounded bg-default/50 px-2 py-1 text-sm">hsb(219, 58%, 93%)</code></div></div></div></div>
```
