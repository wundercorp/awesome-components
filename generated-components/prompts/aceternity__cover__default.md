...
- Source page: https://21st.dev/community/components/aceternity/cover/default
- Registry URL: https://21st.dev/r/aceternity/cover
- Author: aceternity
- Component slug: cover
- Demo slug: default
- Title: cover
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/cover with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__cover__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__cover__default.png
