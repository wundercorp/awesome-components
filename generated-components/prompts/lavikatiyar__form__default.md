...
- Source page: https://21st.dev/community/components/lavikatiyar/form/default
- Registry URL: https://21st.dev/r/lavikatiyar/form
- Author: lavikatiyar
- Component slug: form
- Demo slug: default
- Title: form
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/form with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__form__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__form__default.png
