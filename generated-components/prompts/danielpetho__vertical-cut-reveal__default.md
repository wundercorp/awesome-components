...
- Source page: https://21st.dev/community/components/danielpetho/vertical-cut-reveal/default
- Registry URL: https://21st.dev/r/danielpetho/vertical-cut-reveal
- Author: danielpetho
- Component slug: vertical-cut-reveal
- Demo slug: default
- Title: vertical-cut-reveal
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/vertical-cut-reveal with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__vertical-cut-reveal__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__vertical-cut-reveal__default.png
