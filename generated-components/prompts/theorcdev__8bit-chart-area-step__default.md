...
- Source page: https://21st.dev/community/components/theorcdev/8bit-chart-area-step/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-chart-area-step
- Author: theorcdev
- Component slug: 8bit-chart-area-step
- Demo slug: default
- Title: 8bit-chart-area-step
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-chart-area-step with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-chart-area-step__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-chart-area-step__default.png
