...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-field/with-validation
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-field
- Author: hero_ui
- Component slug: heroui-date-field
- Demo slug: with-validation
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-field__with-validation.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-field__with-validation.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><style>
    ...
    </style><div class="date-field w-[256px]" data-required="true" data-slot="date-field" role="group" minvalue="2026-06-27"><label data-required="true" data-slot="label">Date</label><div class="date-input-group date-input-group--primary" data-slot="date-input-group" data-variant="primary"><div aria-label="date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="date"></div></div><span data-slot="description">Enter a date from today onwards</span></div></div></div>
```
