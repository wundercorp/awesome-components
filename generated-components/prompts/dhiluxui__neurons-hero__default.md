...
- Source page: https://21st.dev/community/components/dhiluxui/neurons-hero/default
- Registry URL: https://21st.dev/r/dhiluxui/neurons-hero
- Author: dhiluxui
- Component slug: neurons-hero
- Demo slug: default
- Title: neurons-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/neurons-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__neurons-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__neurons-hero__default.png
