...
- Source page: https://21st.dev/community/components/itsankitverma/3d-image-card/default
- Registry URL: https://21st.dev/r/itsankitverma/3d-image-card
- Author: itsankitverma
- Component slug: 3d-image-card
- Demo slug: default
- Title: 3d-image-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/itsankitverma/3d-image-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/itsankitverma__3d-image-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/itsankitverma__3d-image-card__default.png
