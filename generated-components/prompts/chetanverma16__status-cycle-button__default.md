...
- Source page: https://21st.dev/community/components/chetanverma16/status-cycle-button/default
- Registry URL: https://21st.dev/r/chetanverma16/status-cycle-button
- Author: chetanverma16
- Component slug: status-cycle-button
- Demo slug: default
- Title: status-cycle-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/chetanverma16/status-cycle-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/chetanverma16__status-cycle-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/chetanverma16__status-cycle-button__default.png
