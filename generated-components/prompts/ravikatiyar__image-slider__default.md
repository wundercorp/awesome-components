...
- Source page: https://21st.dev/community/components/ravikatiyar/image-slider/default
- Registry URL: https://21st.dev/r/ravikatiyar/image-slider
- Author: ravikatiyar
- Component slug: image-slider
- Demo slug: default
- Title: image-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/image-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__image-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__image-slider__default.png
