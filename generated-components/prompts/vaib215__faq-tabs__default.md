...
- Source page: https://21st.dev/community/components/vaib215/faq-tabs/default
- Registry URL: https://21st.dev/r/vaib215/faq-tabs
- Author: vaib215
- Component slug: faq-tabs
- Demo slug: default
- Title: faq-tabs
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/vaib215/faq-tabs with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/vaib215__faq-tabs__default.html
- Local screenshot file: generated-21st-prompts/screenshots/vaib215__faq-tabs__default.png
