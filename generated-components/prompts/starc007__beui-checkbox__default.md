...
- Source page: https://21st.dev/community/components/starc007/beui-checkbox/default
- Registry URL: https://21st.dev/r/starc007/beui-checkbox
- Author: starc007
- Component slug: beui-checkbox
- Demo slug: default
- Title: beui-checkbox
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/starc007/beui-checkbox with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/starc007__beui-checkbox__default.html
- Local screenshot file: generated-21st-prompts/screenshots/starc007__beui-checkbox__default.png
