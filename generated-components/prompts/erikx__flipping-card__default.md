...
- Source page: https://21st.dev/community/components/erikx/flipping-card/default
- Registry URL: https://21st.dev/r/erikx/flipping-card
- Author: erikx
- Component slug: flipping-card
- Demo slug: default
- Title: flipping-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/flipping-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__flipping-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__flipping-card__default.png
