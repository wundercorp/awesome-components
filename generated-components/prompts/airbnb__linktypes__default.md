...
- Source page: https://21st.dev/community/components/airbnb/linktypes/default
- Registry URL: https://21st.dev/r/airbnb/linktypes
- Author: airbnb
- Component slug: linktypes
- Demo slug: default
- Title: linktypes
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/airbnb/linktypes with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/airbnb__linktypes__default.html
- Local screenshot file: generated-21st-prompts/screenshots/airbnb__linktypes__default.png
