...
- Source page: https://21st.dev/community/components/isaiahbjork/weekly-kpi-chart/default
- Registry URL: https://21st.dev/r/isaiahbjork/weekly-kpi-chart
- Author: isaiahbjork
- Component slug: weekly-kpi-chart
- Demo slug: default
- Title: weekly-kpi-chart
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/isaiahbjork/weekly-kpi-chart with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/isaiahbjork__weekly-kpi-chart__default.html
- Local screenshot file: generated-21st-prompts/screenshots/isaiahbjork__weekly-kpi-chart__default.png
