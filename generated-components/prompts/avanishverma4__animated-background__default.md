...
- Source page: https://21st.dev/community/components/avanishverma4/animated-background/default
- Registry URL: https://21st.dev/r/avanishverma4/animated-background
- Author: avanishverma4
- Component slug: animated-background
- Demo slug: default
- Title: animated-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/animated-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__animated-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__animated-background__default.png
