...
- Source page: https://21st.dev/community/components/isaiahbjork/news-cards/default
- Registry URL: https://21st.dev/r/isaiahbjork/news-cards
- Author: isaiahbjork
- Component slug: news-cards
- Demo slug: default
- Title: news-cards
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/isaiahbjork/news-cards with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/isaiahbjork__news-cards__default.html
- Local screenshot file: generated-21st-prompts/screenshots/isaiahbjork__news-cards__default.png
