...
- Source page: https://21st.dev/community/components/shugar/theme-switcher/default
- Registry URL: https://21st.dev/r/shugar/theme-switcher
- Author: shugar
- Component slug: theme-switcher
- Demo slug: default
- Title: theme-switcher
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/theme-switcher with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__theme-switcher__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__theme-switcher__default.png
