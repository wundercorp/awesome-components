...
- Source page: https://21st.dev/community/components/ravikatiyar/sky-toggle/default
- Registry URL: https://21st.dev/r/ravikatiyar/sky-toggle
- Author: ravikatiyar
- Component slug: sky-toggle
- Demo slug: default
- Title: sky-toggle
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/sky-toggle with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__sky-toggle__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__sky-toggle__default.png
