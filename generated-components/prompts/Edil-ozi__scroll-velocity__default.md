...
- Source page: https://21st.dev/community/components/Edil-ozi/scroll-velocity/default
- Registry URL: https://21st.dev/r/Edil-ozi/scroll-velocity
- Author: Edil-ozi
- Component slug: scroll-velocity
- Demo slug: default
- Title: scroll-velocity
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Edil-ozi/scroll-velocity with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Edil-ozi__scroll-velocity__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Edil-ozi__scroll-velocity__default.png
