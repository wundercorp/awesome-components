...
- Source page: https://21st.dev/community/components/ruixenui/health-stat-card/default
- Registry URL: https://21st.dev/r/ruixenui/health-stat-card
- Author: ruixenui
- Component slug: health-stat-card
- Demo slug: default
- Title: health-stat-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/health-stat-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__health-stat-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__health-stat-card__default.png
