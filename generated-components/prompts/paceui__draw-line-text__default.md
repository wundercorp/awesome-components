...
- Source page: https://21st.dev/community/components/paceui/draw-line-text/default
- Registry URL: https://21st.dev/r/paceui/draw-line-text
- Author: paceui
- Component slug: draw-line-text
- Demo slug: default
- Title: draw-line-text
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/paceui/draw-line-text with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/paceui__draw-line-text__default.html
- Local screenshot file: generated-21st-prompts/screenshots/paceui__draw-line-text__default.png
