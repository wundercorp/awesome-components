...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-field/full-width
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-field__full-width.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-field__full-width.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="w-[400px] space-y-4"><style>
    ...
    </style><div class="date-field date-field--full-width" data-full-width="true" data-slot="date-field" role="group"><label data-slot="label">Date</label><div class="date-input-group date-input-group--primary date-input-group--full-width" data-full-width="true" data-slot="date-input-group" data-variant="primary"><div aria-label="date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="date"></div></div></div><style>
      [data-slot="date-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
      ...
      .light [data-slot="select-popover"],
      .light [data-slot="tooltip-content"] { background: hsl(var(--surface, 0 0% 100%)); color: hsl(var(--foreground, 240 10% 4%)); border-color: hsl(var(--border, 240 6% 90%)); box-shadow: 0 10px 30px rgb(0 0 0 / .08); }
    </style><div class="date-field date-field--full-width" data-full-width="true" data-slot="date-field" role="group"><label data-slot="label">Date</label><div class="date-input-group date-input-group--primary date-input-group--full-width" data-full-width="true" data-slot="date-input-group" data-variant="primary"><div class="date-input-group__prefix" data-slot="date-input-group-prefix"><svg aria-hidden="true" class="size-4 text-muted" fill="none" height="16" viewBox="0 0 16 16" width="16"><path d="M4.5 1.5v2m7-2v2m-9 2.5h11m-10-3.5h9a1.5 1.5 0 0 1 1.5 1.5v8.5A1.5 1.5 0 0 1 12.5 14h-9A1.5 1.5 0 0 1 2 12.5V4a1.5 1.5 0 0 1 1.5-1.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg></div><div aria-label="date-icons" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="date-icons"></div><div class="date-input-group__suffix" data-slot="date-input-group-suffix"><svg aria-hidden="true" class="size-4 text-muted" fill="none" height="16" viewBox="0 0 16 16" width="16"><path d="m4 6 4 4 4-4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg></div></div></div></div></div></div>
```
