...
- Source page: https://21st.dev/community/components/shugar/tabs/default
- Registry URL: https://21st.dev/r/shugar/tabs
- Author: shugar
- Component slug: tabs
- Demo slug: default
- Title: tabs
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/tabs with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__tabs__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__tabs__default.png
