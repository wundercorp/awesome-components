...
- Source page: https://21st.dev/community/components/arunachalam0606/bottom-nav-bar/default
- Registry URL: https://21st.dev/r/arunachalam0606/bottom-nav-bar
- Author: arunachalam0606
- Component slug: bottom-nav-bar
- Demo slug: default
- Title: bottom-nav-bar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arunachalam0606/bottom-nav-bar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arunachalam0606__bottom-nav-bar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arunachalam0606__bottom-nav-bar__default.png
