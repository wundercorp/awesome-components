...
- Source page: https://21st.dev/community/components/shadcn/menubar/default
- Registry URL: https://21st.dev/r/shadcn/menubar
- Author: shadcn
- Component slug: menubar
- Demo slug: default
- Title: menubar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/menubar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__menubar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__menubar__default.png
