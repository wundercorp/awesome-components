...
- Source page: https://21st.dev/community/components/suraj-xd/liquid-glass/default
- Registry URL: https://21st.dev/r/suraj-xd/liquid-glass
- Author: suraj-xd
- Component slug: liquid-glass
- Demo slug: default
- Title: liquid-glass
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/suraj-xd/liquid-glass with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/suraj-xd__liquid-glass__default.html
- Local screenshot file: generated-21st-prompts/screenshots/suraj-xd__liquid-glass__default.png
