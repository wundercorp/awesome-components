...
- Source page: https://21st.dev/community/components/avanishverma4/floating-card/default
- Registry URL: https://21st.dev/r/avanishverma4/floating-card
- Author: avanishverma4
- Component slug: floating-card
- Demo slug: default
- Title: floating-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/floating-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__floating-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__floating-card__default.png
