...
- Source page: https://21st.dev/community/components/spydiecy/stacked-activity-cards/default
- Registry URL: https://21st.dev/r/spydiecy/stacked-activity-cards
- Author: spydiecy
- Component slug: stacked-activity-cards
- Demo slug: default
- Title: stacked-activity-cards
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/spydiecy/stacked-activity-cards with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/spydiecy__stacked-activity-cards__default.html
- Local screenshot file: generated-21st-prompts/screenshots/spydiecy__stacked-activity-cards__default.png
