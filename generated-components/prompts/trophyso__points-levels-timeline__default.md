...
- Source page: https://21st.dev/community/components/trophyso/points-levels-timeline/default
- Registry URL: https://21st.dev/r/trophyso/points-levels-timeline
- Author: trophyso
- Component slug: points-levels-timeline
- Demo slug: default
- Title: points-levels-timeline
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/trophyso/points-levels-timeline with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/trophyso__points-levels-timeline__default.html
- Local screenshot file: generated-21st-prompts/screenshots/trophyso__points-levels-timeline__default.png
