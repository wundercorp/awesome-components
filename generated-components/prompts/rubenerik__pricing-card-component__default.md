...
- Source page: https://21st.dev/community/components/rubenerik/pricing-card-component/default
- Registry URL: https://21st.dev/r/rubenerik/pricing-card-component
- Author: rubenerik
- Component slug: pricing-card-component
- Demo slug: default
- Title: pricing-card-component
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/rubenerik/pricing-card-component with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/rubenerik__pricing-card-component__default.html
- Local screenshot file: generated-21st-prompts/screenshots/rubenerik__pricing-card-component__default.png
