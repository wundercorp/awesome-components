...
- Source page: https://21st.dev/community/components/ravikatiyar/service-grid/default
- Registry URL: https://21st.dev/r/ravikatiyar/service-grid
- Author: ravikatiyar
- Component slug: service-grid
- Demo slug: default
- Title: service-grid
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/service-grid with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__service-grid__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__service-grid__default.png
