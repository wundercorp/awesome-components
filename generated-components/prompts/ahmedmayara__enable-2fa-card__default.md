...
- Source page: https://21st.dev/community/components/ahmedmayara/enable-2fa-card/default
- Registry URL: https://21st.dev/r/ahmedmayara/enable-2fa-card
- Author: ahmedmayara
- Component slug: enable-2fa-card
- Demo slug: default
- Title: enable-2fa-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ahmedmayara/enable-2fa-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ahmedmayara__enable-2fa-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ahmedmayara__enable-2fa-card__default.png
