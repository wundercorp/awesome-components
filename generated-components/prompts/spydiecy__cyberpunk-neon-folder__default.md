...
- Source page: https://21st.dev/community/components/spydiecy/cyberpunk-neon-folder/default
- Registry URL: https://21st.dev/r/spydiecy/cyberpunk-neon-folder
- Author: spydiecy
- Component slug: cyberpunk-neon-folder
- Demo slug: default
- Title: cyberpunk-neon-folder
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/spydiecy/cyberpunk-neon-folder with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/spydiecy__cyberpunk-neon-folder__default.html
- Local screenshot file: generated-21st-prompts/screenshots/spydiecy__cyberpunk-neon-folder__default.png
