...
- Source page: https://21st.dev/community/components/arhamkhnz/radial-intro/default
- Registry URL: https://21st.dev/r/arhamkhnz/radial-intro
- Author: arhamkhnz
- Component slug: radial-intro
- Demo slug: default
- Title: radial-intro
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arhamkhnz/radial-intro with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arhamkhnz__radial-intro__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arhamkhnz__radial-intro__default.png
