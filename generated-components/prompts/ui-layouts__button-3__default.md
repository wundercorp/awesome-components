...
- Source page: https://21st.dev/community/components/ui-layouts/button-3/default
- Registry URL: https://21st.dev/r/ui-layouts/button-3
- Author: ui-layouts
- Component slug: button-3
- Demo slug: default
- Title: button-3
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/button-3 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__button-3__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__button-3__default.png
