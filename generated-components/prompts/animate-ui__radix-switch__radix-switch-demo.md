...
- Source page: https://21st.dev/community/components/animate-ui/radix-switch/radix-switch-demo
- Registry URL: https://21st.dev/r/animate-ui/radix-switch
- Author: animate-ui
- Component slug: radix-switch
- Demo slug: radix-switch-demo
- Title: radix-switch
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/animate-ui/radix-switch with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/animate-ui__radix-switch__radix-switch-demo.html
- Local screenshot file: generated-21st-prompts/screenshots/animate-ui__radix-switch__radix-switch-demo.png
