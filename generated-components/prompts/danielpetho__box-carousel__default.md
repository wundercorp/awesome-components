...
- Source page: https://21st.dev/community/components/danielpetho/box-carousel/default
- Registry URL: https://21st.dev/r/danielpetho/box-carousel
- Author: danielpetho
- Component slug: box-carousel
- Demo slug: default
- Title: box-carousel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/box-carousel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__box-carousel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__box-carousel__default.png
