...
- Source page: https://21st.dev/community/components/avanishverma4/3d-tilt-card/default
- Registry URL: https://21st.dev/r/avanishverma4/3d-tilt-card
- Author: avanishverma4
- Component slug: 3d-tilt-card
- Demo slug: default
- Title: 3d-tilt-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/3d-tilt-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__3d-tilt-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__3d-tilt-card__default.png
