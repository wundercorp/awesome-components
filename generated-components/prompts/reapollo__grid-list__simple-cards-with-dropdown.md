...
- Source page: https://21st.dev/community/components/reapollo/grid-list/simple-cards-with-dropdown
- Registry URL: https://21st.dev/r/reapollo/grid-list
- Author: reapollo
- Component slug: grid-list
- Demo slug: simple-cards-with-dropdown
- Title: grid-list
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/grid-list with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__grid-list__simple-cards-with-dropdown.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__grid-list__simple-cards-with-dropdown.png
