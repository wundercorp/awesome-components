...
- Source page: https://21st.dev/community/components/hextaui/alert/default
- Registry URL: https://21st.dev/r/hextaui/alert
- Author: hextaui
- Component slug: alert
- Demo slug: default
- Title: alert
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/alert with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__alert__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__alert__default.png
