...
- Source page: https://21st.dev/community/components/uniquesonu/modern-side-bar/default
- Registry URL: https://21st.dev/r/uniquesonu/modern-side-bar
- Author: uniquesonu
- Component slug: modern-side-bar
- Demo slug: default
- Title: modern-side-bar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/modern-side-bar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__modern-side-bar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__modern-side-bar__default.png
