...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/validation
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__validation.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__validation.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field" data-invalid="true" data-required="true"><label class="label" data-required="true" data-slot="label" for="_r_0_">Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input aria-invalid="true" autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_0_" inputmode="text" placeholder="#000000" spellcheck="false" type="text" value="" name="color"></div><span class="field-error" data-slot="field-error" data-visible="true">Please enter a valid hex color</span></div><style>
      [data-slot="color-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field" data-invalid="true"><label class="label" data-slot="label" for="_r_1_">Background Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input aria-invalid="true" autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_1_" inputmode="text" spellcheck="false" type="text" value="" name="invalid-color"></div><span class="field-error" data-slot="field-error" data-visible="true">Invalid color format. Use hex (e.g., #FF5733)</span></div></div></div></div>
```
