...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/on-surface
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__on-surface.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__on-surface.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="surface surface--default w-[320px] p-4" data-slot="surface"><style>
    ...
    </style><div class="color-field" data-slot="color-field"><label class="label" data-slot="label" for="_r_0_">Theme Color</label><div role="presentation" class="color-input-group color-input-group--secondary" data-slot="color-input-group" data-variant="secondary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_0_" inputmode="text" spellcheck="false" type="text" value="#3B82F6" name="color"></div><span class="description" data-slot="description">Select your theme color</span></div></div></div></div>
```
