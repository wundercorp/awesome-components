...
- Source page: https://21st.dev/community/components/ravikatiyar/download-toast/default
- Registry URL: https://21st.dev/r/ravikatiyar/download-toast
- Author: ravikatiyar
- Component slug: download-toast
- Demo slug: default
- Title: download-toast
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/download-toast with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__download-toast__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__download-toast__default.png
