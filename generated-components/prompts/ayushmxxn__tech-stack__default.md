...
- Source page: https://21st.dev/community/components/ayushmxxn/tech-stack/default
- Registry URL: https://21st.dev/r/ayushmxxn/tech-stack
- Author: ayushmxxn
- Component slug: tech-stack
- Demo slug: default
- Title: tech-stack
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ayushmxxn/tech-stack with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ayushmxxn__tech-stack__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ayushmxxn__tech-stack__default.png
