...
- Source page: https://21st.dev/community/components/user_hardp/switch-button/default
- Registry URL: https://21st.dev/r/user_hardp/switch-button
- Author: user_hardp
- Component slug: switch-button
- Demo slug: default
- Title: switch-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/user_hardp/switch-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/user_hardp__switch-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/user_hardp__switch-button__default.png
