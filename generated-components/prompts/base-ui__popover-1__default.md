...
- Source page: https://21st.dev/community/components/base-ui/popover-1/default
- Registry URL: https://21st.dev/r/base-ui/popover-1
- Author: base-ui
- Component slug: popover-1
- Demo slug: default
- Title: popover-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/base-ui/popover-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/base-ui__popover-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/base-ui__popover-1__default.png
