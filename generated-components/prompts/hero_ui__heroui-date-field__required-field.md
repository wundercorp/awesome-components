...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-field/required-field
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-field
- Author: hero_ui
- Component slug: heroui-date-field
- Demo slug: required-field
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-field__required-field.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-field__required-field.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
      ...
      .light [data-slot="select-popover"],
      .light [data-slot="tooltip-content"] { background: hsl(var(--surface, 0 0% 100%)); color: hsl(var(--foreground, 240 10% 4%)); border-color: hsl(var(--border, 240 6% 90%)); box-shadow: 0 10px 30px rgb(0 0 0 / .08); }
    </style><div class="date-field w-[256px]" data-required="true" data-slot="date-field" role="group"><label data-required="true" data-slot="label">Start date</label><div class="date-input-group date-input-group--primary" data-slot="date-input-group" data-variant="primary"><div aria-label="start-date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="start-date"></div></div><span data-slot="description">Required field</span></div></div></div></div>
```
