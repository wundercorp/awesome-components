...
- Source page: https://21st.dev/community/components/reui/base-input/disabled
- Registry URL: https://21st.dev/r/reui/base-input
- Author: reui
- Component slug: base-input
- Demo slug: disabled
- Title: base-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reui/base-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reui__base-input__disabled.html
- Local screenshot file: generated-21st-prompts/screenshots/reui__base-input__disabled.png
