...
- Source page: https://21st.dev/community/components/serafim/fey-button/default
- Registry URL: https://21st.dev/r/serafim/fey-button
- Author: serafim
- Component slug: fey-button
- Demo slug: default
- Title: fey-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/serafim/fey-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/serafim__fey-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/serafim__fey-button__default.png
