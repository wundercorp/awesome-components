...
- Source page: https://21st.dev/community/components/hextaui/scroll-area/default
- Registry URL: https://21st.dev/r/hextaui/scroll-area
- Author: hextaui
- Component slug: scroll-area
- Demo slug: default
- Title: scroll-area
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/scroll-area with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__scroll-area__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__scroll-area__default.png
