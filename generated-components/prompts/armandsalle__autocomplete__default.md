...
- Source page: https://21st.dev/community/components/armandsalle/autocomplete/default
- Registry URL: https://21st.dev/r/armandsalle/autocomplete
- Author: armandsalle
- Component slug: autocomplete
- Demo slug: default
- Title: autocomplete
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/armandsalle/autocomplete with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/armandsalle__autocomplete__default.html
- Local screenshot file: generated-21st-prompts/screenshots/armandsalle__autocomplete__default.png
