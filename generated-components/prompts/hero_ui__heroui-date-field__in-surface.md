...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-field/in-surface
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-field
- Author: hero_ui
- Component slug: heroui-date-field
- Demo slug: in-surface
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-field__in-surface.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-field__in-surface.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="w-[340px] p-4" data-slot="surface"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="date-field w-[256px]" data-slot="date-field" role="group"><label data-slot="label">Date</label><div class="date-input-group date-input-group--secondary" data-slot="date-input-group" data-variant="secondary"><div class="date-input-group__prefix" data-slot="date-input-group-prefix"><svg aria-hidden="true" class="size-4 text-muted" fill="none" height="16" viewBox="0 0 16 16" width="16"><path d="M4.5 1.5v2m7-2v2m-9 2.5h11m-10-3.5h9a1.5 1.5 0 0 1 1.5 1.5v8.5A1.5 1.5 0 0 1 12.5 14h-9A1.5 1.5 0 0 1 2 12.5V4a1.5 1.5 0 0 1 1.5-1.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg></div><div aria-label="date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="date"></div></div><span data-slot="description">Enter a date</span></div><style>
      [data-slot="date-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
      ...
      .light [data-slot="select-popover"],
      .light [data-slot="tooltip-content"] { background: hsl(var(--surface, 0 0% 100%)); color: hsl(var(--foreground, 240 10% 4%)); border-color: hsl(var(--border, 240 6% 90%)); box-shadow: 0 10px 30px rgb(0 0 0 / .08); }
    </style><div class="date-field w-[256px]" data-slot="date-field" role="group"><label data-slot="label">Appointment date</label><div class="date-input-group date-input-group--secondary" data-slot="date-input-group" data-variant="secondary"><div aria-label="appointment-date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton" tabindex="0">mm</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton" tabindex="0">dd</span><span class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton" tabindex="0">yyyy</span><input readonly="" type="hidden" value="" name="appointment-date"></div></div><span data-slot="description">Enter a date for your appointment</span></div></div></div></div></div>
```
