...
- Source page: https://21st.dev/community/components/danielpetho/text-cursor-proximity/default
- Registry URL: https://21st.dev/r/danielpetho/text-cursor-proximity
- Author: danielpetho
- Component slug: text-cursor-proximity
- Demo slug: default
- Title: text-cursor-proximity
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/text-cursor-proximity with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__text-cursor-proximity__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__text-cursor-proximity__default.png
