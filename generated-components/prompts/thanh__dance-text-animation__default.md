...
- Source page: https://21st.dev/community/components/thanh/dance-text-animation/default
- Registry URL: https://21st.dev/r/thanh/dance-text-animation
- Author: thanh
- Component slug: dance-text-animation
- Demo slug: default
- Title: dance-text-animation
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/dance-text-animation with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__dance-text-animation__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__dance-text-animation__default.png
