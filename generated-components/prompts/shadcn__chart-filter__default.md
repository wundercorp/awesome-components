...
- Source page: https://21st.dev/community/components/shadcn/chart-filter/default
- Registry URL: https://21st.dev/r/shadcn/chart-filter
- Author: shadcn
- Component slug: chart-filter
- Demo slug: default
- Title: chart-filter
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/chart-filter with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__chart-filter__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__chart-filter__default.png
