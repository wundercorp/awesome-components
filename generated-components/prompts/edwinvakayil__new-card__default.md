...
- Source page: https://21st.dev/community/components/edwinvakayil/new-card/default
- Registry URL: https://21st.dev/r/edwinvakayil/new-card
- Author: edwinvakayil
- Component slug: new-card
- Demo slug: default
- Title: new-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/new-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__new-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__new-card__default.png
