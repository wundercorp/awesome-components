...
- Source page: https://21st.dev/community/components/axorax/cta-card-1/default
- Registry URL: https://21st.dev/r/axorax/cta-card-1
- Author: axorax
- Component slug: cta-card-1
- Demo slug: default
- Title: cta-card-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/axorax/cta-card-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/axorax__cta-card-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/axorax__cta-card-1__default.png
