...
- Source page: https://21st.dev/community/components/TomIsLoading/kanban/default
- Registry URL: https://21st.dev/r/TomIsLoading/kanban
- Author: TomIsLoading
- Component slug: kanban
- Demo slug: default
- Title: kanban
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/TomIsLoading/kanban with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/TomIsLoading__kanban__default.html
- Local screenshot file: generated-21st-prompts/screenshots/TomIsLoading__kanban__default.png
