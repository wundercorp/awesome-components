...
- Source page: https://21st.dev/community/components/anurag-mishra22/progress-indicator/default
- Registry URL: https://21st.dev/r/anurag-mishra22/progress-indicator
- Author: anurag-mishra22
- Component slug: progress-indicator
- Demo slug: default
- Title: progress-indicator
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/anurag-mishra22/progress-indicator with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/anurag-mishra22__progress-indicator__default.html
- Local screenshot file: generated-21st-prompts/screenshots/anurag-mishra22__progress-indicator__default.png
