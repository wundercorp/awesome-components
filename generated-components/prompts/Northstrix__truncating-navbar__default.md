...
- Source page: https://21st.dev/community/components/Northstrix/truncating-navbar/default
- Registry URL: https://21st.dev/r/Northstrix/truncating-navbar
- Author: Northstrix
- Component slug: truncating-navbar
- Demo slug: default
- Title: truncating-navbar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Northstrix/truncating-navbar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Northstrix__truncating-navbar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Northstrix__truncating-navbar__default.png
