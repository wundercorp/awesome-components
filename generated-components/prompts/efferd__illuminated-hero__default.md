...
- Source page: https://21st.dev/community/components/efferd/illuminated-hero/default
- Registry URL: https://21st.dev/r/efferd/illuminated-hero
- Author: efferd
- Component slug: illuminated-hero
- Demo slug: default
- Title: illuminated-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/efferd/illuminated-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/efferd__illuminated-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/efferd__illuminated-hero__default.png
