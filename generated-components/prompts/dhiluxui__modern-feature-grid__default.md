...
- Source page: https://21st.dev/community/components/dhiluxui/modern-feature-grid/default
- Registry URL: https://21st.dev/r/dhiluxui/modern-feature-grid
- Author: dhiluxui
- Component slug: modern-feature-grid
- Demo slug: default
- Title: modern-feature-grid
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/modern-feature-grid with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__modern-feature-grid__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__modern-feature-grid__default.png
