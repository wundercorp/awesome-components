...
- Source page: https://21st.dev/community/components/magicui/animated-shiny-text/default
- Registry URL: https://21st.dev/r/magicui/animated-shiny-text
- Author: magicui
- Component slug: animated-shiny-text
- Demo slug: default
- Title: animated-shiny-text
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/magicui/animated-shiny-text with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/magicui__animated-shiny-text__default.html
- Local screenshot file: generated-21st-prompts/screenshots/magicui__animated-shiny-text__default.png
