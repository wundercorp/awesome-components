...
- Source page: https://21st.dev/community/components/ln-dev7/pricing-interaction/default
- Registry URL: https://21st.dev/r/ln-dev7/pricing-interaction
- Author: ln-dev7
- Component slug: pricing-interaction
- Demo slug: default
- Title: pricing-interaction
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ln-dev7/pricing-interaction with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ln-dev7__pricing-interaction__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ln-dev7__pricing-interaction__default.png
