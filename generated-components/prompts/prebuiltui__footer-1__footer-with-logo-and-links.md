...
- Source page: https://21st.dev/community/components/prebuiltui/footer-1/footer-with-logo-and-links
- Registry URL: https://21st.dev/r/prebuiltui/footer-1
- Author: prebuiltui
- Component slug: footer-1
- Demo slug: footer-with-logo-and-links
- Title: footer-1
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/prebuiltui__footer-1__footer-with-logo-and-links.html
- Local screenshot file: generated-21st-prompts/screenshots/prebuiltui__footer-1__footer-with-logo-and-links.png
