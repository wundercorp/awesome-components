...
- Source page: https://21st.dev/community/components/kavikatiyar/tracker-card-1/default
- Registry URL: https://21st.dev/r/kavikatiyar/tracker-card-1
- Author: kavikatiyar
- Component slug: tracker-card-1
- Demo slug: default
- Title: tracker-card-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/tracker-card-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__tracker-card-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__tracker-card-1__default.png
