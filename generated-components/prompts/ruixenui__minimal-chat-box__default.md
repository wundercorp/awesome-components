...
- Source page: https://21st.dev/community/components/ruixenui/minimal-chat-box/default
- Registry URL: https://21st.dev/r/ruixenui/minimal-chat-box
- Author: ruixenui
- Component slug: minimal-chat-box
- Demo slug: default
- Title: minimal-chat-box
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/minimal-chat-box with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__minimal-chat-box__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__minimal-chat-box__default.png
