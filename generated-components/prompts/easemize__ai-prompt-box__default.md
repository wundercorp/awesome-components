...
- Source page: https://21st.dev/community/components/easemize/ai-prompt-box/default
- Registry URL: https://21st.dev/r/easemize/ai-prompt-box
- Author: easemize
- Component slug: ai-prompt-box
- Demo slug: default
- Title: ai-prompt-box
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/ai-prompt-box with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__ai-prompt-box__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__ai-prompt-box__default.png
