...
- Source page: https://21st.dev/community/components/efferd/footer-section/default
- Registry URL: https://21st.dev/r/efferd/footer-section
- Author: efferd
- Component slug: footer-section
- Demo slug: default
- Title: footer-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/efferd/footer-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/efferd__footer-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/efferd__footer-section__default.png
