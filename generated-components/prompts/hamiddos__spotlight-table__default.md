...
- Source page: https://21st.dev/community/components/hamiddos/spotlight-table/default
- Registry URL: https://21st.dev/r/hamiddos/spotlight-table
- Author: hamiddos
- Component slug: spotlight-table
- Demo slug: default
- Title: spotlight-table
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hamiddos/spotlight-table with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hamiddos__spotlight-table__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hamiddos__spotlight-table__default.png
