...
- Source page: https://21st.dev/community/components/reui/outline-accordion/default
- Registry URL: https://21st.dev/r/reui/outline-accordion
- Author: reui
- Component slug: outline-accordion
- Demo slug: default
- Title: outline-accordion
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reui/outline-accordion with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reui__outline-accordion__default.html
- Local screenshot file: generated-21st-prompts/screenshots/reui__outline-accordion__default.png
