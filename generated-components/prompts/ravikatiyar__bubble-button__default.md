...
- Source page: https://21st.dev/community/components/ravikatiyar/bubble-button/default
- Registry URL: https://21st.dev/r/ravikatiyar/bubble-button
- Author: ravikatiyar
- Component slug: bubble-button
- Demo slug: default
- Title: bubble-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/bubble-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__bubble-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__bubble-button__default.png
