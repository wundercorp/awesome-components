...
- Source page: https://21st.dev/community/components/originui/button/menu-button
- Registry URL: https://21st.dev/r/originui/button
- Author: originui
- Component slug: button
- Demo slug: menu-button
- Title: button
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/originui__button__menu-button.html
- Local screenshot file: generated-21st-prompts/screenshots/originui__button__menu-button.png
