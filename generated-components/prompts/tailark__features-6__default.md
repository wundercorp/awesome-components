...
- Source page: https://21st.dev/community/components/tailark/features-6/default
- Registry URL: https://21st.dev/r/tailark/features-6
- Author: tailark
- Component slug: features-6
- Demo slug: default
- Title: features-6
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tailark/features-6 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tailark__features-6__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tailark__features-6__default.png
...
```html
<div id="root"><div class="bg-background text-foreground"><div class="w-full"><section class="py-16 md:py-32"><div class="mx-auto max-w-5xl space-y-12 px-6"><div class="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12"><h2 class="text-4xl font-semibold">The Lyra ecosystem brings together our models</h2><p class="max-w-sm sm:ml-auto">Empower your team with workflows that adapt to your needs, whether you prefer git synchronization or a AI Agents interface.</p></div><div class="relative rounded-3xl p-3 md:-mx-8 lg:col-span-3"><div class="aspect-[88/36] relative"><div class="bg-gradient-to-t z-1 from-background absolute inset-0 to-transparent"></div><img class="absolute inset-0 z-10" alt="payments illustration dark" width="2797" height="1137" src="https://tailark.com/_next/image?url=%2Fmail-upper.png&amp;w=3840&amp;q=75"><img class="hidden dark:block" alt="payments illustration dark" width="2797" height="1137" src="https://tailark.com/_next/image?url=%2Fmail-back.png&amp;w=3840&amp;q=75"><img class="dark:hidden" alt="payments illustration light" width="2797" height="1137" src="https://tailark.com/_next/image?url=%2Fmail-back-light.png&amp;w=3840&amp;q=75
