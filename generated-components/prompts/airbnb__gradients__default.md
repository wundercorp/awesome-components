...
- Source page: https://21st.dev/community/components/airbnb/gradients/default
- Registry URL: https://21st.dev/r/airbnb/gradients
- Author: airbnb
- Component slug: gradients
- Demo slug: default
- Title: gradients
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/airbnb/gradients with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/airbnb__gradients__default.html
- Local screenshot file: generated-21st-prompts/screenshots/airbnb__gradients__default.png
