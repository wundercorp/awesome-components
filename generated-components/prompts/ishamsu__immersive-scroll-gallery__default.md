...
- Source page: https://21st.dev/community/components/ishamsu/immersive-scroll-gallery/default
- Registry URL: https://21st.dev/r/ishamsu/immersive-scroll-gallery
- Author: ishamsu
- Component slug: immersive-scroll-gallery
- Demo slug: default
- Title: immersive-scroll-gallery
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ishamsu/immersive-scroll-gallery with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ishamsu__immersive-scroll-gallery__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ishamsu__immersive-scroll-gallery__default.png
