...
- Source page: https://21st.dev/community/components/ravikatiyar/delivery-scheduler/default
- Registry URL: https://21st.dev/r/ravikatiyar/delivery-scheduler
- Author: ravikatiyar
- Component slug: delivery-scheduler
- Demo slug: default
- Title: delivery-scheduler
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/delivery-scheduler with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__delivery-scheduler__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__delivery-scheduler__default.png
