...
- Source page: https://21st.dev/community/components/shadway/portfolio-hero-with-paper-shaders/default
- Registry URL: https://21st.dev/r/shadway/portfolio-hero-with-paper-shaders
- Author: shadway
- Component slug: portfolio-hero-with-paper-shaders
- Demo slug: default
- Title: portfolio-hero-with-paper-shaders
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadway/portfolio-hero-with-paper-shaders with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadway__portfolio-hero-with-paper-shaders__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadway__portfolio-hero-with-paper-shaders__default.png
