...
- Source page: https://21st.dev/community/components/nurui/banner/default
- Registry URL: https://21st.dev/r/nurui/banner
- Author: nurui
- Component slug: banner
- Demo slug: default
- Title: banner
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/nurui/banner with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/nurui__banner__default.html
- Local screenshot file: generated-21st-prompts/screenshots/nurui__banner__default.png
