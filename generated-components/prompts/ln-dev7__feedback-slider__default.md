...
- Source page: https://21st.dev/community/components/ln-dev7/feedback-slider/default
- Registry URL: https://21st.dev/r/ln-dev7/feedback-slider
- Author: ln-dev7
- Component slug: feedback-slider
- Demo slug: default
- Title: feedback-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ln-dev7/feedback-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ln-dev7__feedback-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ln-dev7__feedback-slider__default.png
