...
- Source page: https://21st.dev/community/components/chetanverma16/audio-player/default
- Registry URL: https://21st.dev/r/chetanverma16/audio-player
- Author: chetanverma16
- Component slug: audio-player
- Demo slug: default
- Title: audio-player
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/chetanverma16/audio-player with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/chetanverma16__audio-player__default.html
- Local screenshot file: generated-21st-prompts/screenshots/chetanverma16__audio-player__default.png
