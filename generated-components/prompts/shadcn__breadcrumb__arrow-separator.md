...
- Source page: https://21st.dev/community/components/shadcn/breadcrumb/arrow-separator
- Registry URL: https://21st.dev/r/shadcn/breadcrumb
- Author: shadcn
- Component slug: breadcrumb
- Demo slug: arrow-separator
- Title: breadcrumb
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/breadcrumb with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__breadcrumb__arrow-separator.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__breadcrumb__arrow-separator.png
