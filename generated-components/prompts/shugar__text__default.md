...
- Source page: https://21st.dev/community/components/shugar/text/default
- Registry URL: https://21st.dev/r/shugar/text
- Author: shugar
- Component slug: text
- Demo slug: default
- Title: text
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/text with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__text__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__text__default.png
