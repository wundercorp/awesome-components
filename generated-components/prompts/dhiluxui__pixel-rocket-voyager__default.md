...
- Source page: https://21st.dev/community/components/dhiluxui/pixel-rocket-voyager/default
- Registry URL: https://21st.dev/r/dhiluxui/pixel-rocket-voyager
- Author: dhiluxui
- Component slug: pixel-rocket-voyager
- Demo slug: default
- Title: pixel-rocket-voyager
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/pixel-rocket-voyager with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__pixel-rocket-voyager__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__pixel-rocket-voyager__default.png
