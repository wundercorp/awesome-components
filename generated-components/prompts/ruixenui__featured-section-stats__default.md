...
- Source page: https://21st.dev/community/components/ruixenui/featured-section-stats/default
- Registry URL: https://21st.dev/r/ruixenui/featured-section-stats
- Author: ruixenui
- Component slug: featured-section-stats
- Demo slug: default
- Title: featured-section-stats
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/featured-section-stats with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__featured-section-stats__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__featured-section-stats__default.png
