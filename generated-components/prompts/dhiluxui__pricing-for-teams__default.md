...
- Source page: https://21st.dev/community/components/dhiluxui/pricing-for-teams/default
- Registry URL: https://21st.dev/r/dhiluxui/pricing-for-teams
- Author: dhiluxui
- Component slug: pricing-for-teams
- Demo slug: default
- Title: pricing-for-teams
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/pricing-for-teams with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__pricing-for-teams__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__pricing-for-teams__default.png
