...
- Source page: https://21st.dev/community/components/reapollo/heroui-color-area/with-dots
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__heroui-color-area__with-dots.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__heroui-color-area__with-dots.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><style>
    ...
    </style><div role="group" tabindex="0" aria-label="Color area" data-slot="color-area" class="color-area color-area--show-dots" style="--color-area-background: linear-gradient(to bottom, transparent, hsl(0, 0%, 50%)), linear-gradient(to right, hsl(0, 100%, 50%), hsl(60, 100%, 50%), hsl(120, 100%, 50%), hsl(180, 100%, 50%), hsl(240, 100%, 50%), hsl(300, 100%, 50%), hsl(360, 100%, 50%));"><div data-slot="color-area-thumb" class="color-area__thumb" style="--color-area-thumb-color: rgba(0, 170, 255, 1); left: 55.5556%; top: 0%;"></div></div></div></div>
```
