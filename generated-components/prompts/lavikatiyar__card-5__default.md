...
- Source page: https://21st.dev/community/components/lavikatiyar/card-5/default
- Registry URL: https://21st.dev/r/lavikatiyar/card-5
- Author: lavikatiyar
- Component slug: card-5
- Demo slug: default
- Title: card-5
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/card-5 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__card-5__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__card-5__default.png
