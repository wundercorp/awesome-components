...
- Source page: https://21st.dev/community/components/itsankitverma/credit-card-1/default
- Registry URL: https://21st.dev/r/itsankitverma/credit-card-1
- Author: itsankitverma
- Component slug: credit-card-1
- Demo slug: default
- Title: credit-card-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/itsankitverma/credit-card-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/itsankitverma__credit-card-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/itsankitverma__credit-card-1__default.png
