...
- Source page: https://21st.dev/community/components/beratberkay/stats-cards/default
- Registry URL: https://21st.dev/r/beratberkay/stats-cards
- Author: beratberkay
- Component slug: stats-cards
- Demo slug: default
- Title: stats-cards
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/beratberkay/stats-cards with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/beratberkay__stats-cards__default.html
- Local screenshot file: generated-21st-prompts/screenshots/beratberkay__stats-cards__default.png
