...
- Source page: https://21st.dev/community/components/mapcn/mapcn-layer-markers/default
- Registry URL: https://21st.dev/r/mapcn/mapcn-layer-markers
- Author: mapcn
- Component slug: mapcn-layer-markers
- Demo slug: default
- Title: mapcn-layer-markers
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/mapcn/mapcn-layer-markers with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/mapcn__mapcn-layer-markers__default.html
- Local screenshot file: generated-21st-prompts/screenshots/mapcn__mapcn-layer-markers__default.png
