...
- Source page: https://21st.dev/community/components/originui/button/button-with-tooltip
- Registry URL: https://21st.dev/r/originui/button
- Author: originui
- Component slug: button
- Demo slug: button-with-tooltip
- Title: button
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/originui__button__button-with-tooltip.html
- Local screenshot file: generated-21st-prompts/screenshots/originui__button__button-with-tooltip.png
