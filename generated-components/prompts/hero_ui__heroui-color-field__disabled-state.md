...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/disabled-state
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__disabled-state.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__disabled-state.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field" data-disabled="true"><label class="label" data-slot="label" for="_r_0_">Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary" data-disabled="true"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" disabled="" id="_r_0_" inputmode="text" spellcheck="false" type="text" value="#0485F7" name="color"></div><span class="description" data-slot="description">This color field is disabled</span></div><style>
      [data-slot="color-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field" data-disabled="true"><label class="label" data-slot="label" for="_r_1_">Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary" data-disabled="true"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" disabled="" id="_r_1_" inputmode="text" placeholder="#000000" spellcheck="false" type="text" value="" name="color-empty"></div><span class="description" data-slot="description">This color field is disabled</span></div></div></div></div>
```
