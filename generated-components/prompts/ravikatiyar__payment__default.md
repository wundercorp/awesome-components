...
- Source page: https://21st.dev/community/components/ravikatiyar/payment/default
- Registry URL: https://21st.dev/r/ravikatiyar/payment
- Author: ravikatiyar
- Component slug: payment
- Demo slug: default
- Title: payment
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/payment with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__payment__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__payment__default.png
