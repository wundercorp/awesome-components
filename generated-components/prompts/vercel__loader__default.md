...
- Source page: https://21st.dev/community/components/vercel/loader/default
- Registry URL: https://21st.dev/r/vercel/loader
- Author: vercel
- Component slug: loader
- Demo slug: default
- Title: loader
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/vercel/loader with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/vercel__loader__default.html
- Local screenshot file: generated-21st-prompts/screenshots/vercel__loader__default.png
