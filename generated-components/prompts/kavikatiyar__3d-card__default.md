...
- Source page: https://21st.dev/community/components/kavikatiyar/3d-card/default
- Registry URL: https://21st.dev/r/kavikatiyar/3d-card
- Author: kavikatiyar
- Component slug: 3d-card
- Demo slug: default
- Title: 3d-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/3d-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__3d-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__3d-card__default.png
