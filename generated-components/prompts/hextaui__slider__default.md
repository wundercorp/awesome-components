...
- Source page: https://21st.dev/community/components/hextaui/slider/default
- Registry URL: https://21st.dev/r/hextaui/slider
- Author: hextaui
- Component slug: slider
- Demo slug: default
- Title: slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__slider__default.png
