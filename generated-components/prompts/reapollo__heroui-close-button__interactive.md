...
- Source page: https://21st.dev/community/components/reapollo/heroui-close-button/interactive
- Registry URL: https://21st.dev/r/reapollo/heroui-close-button
- Author: reapollo
- Component slug: heroui-close-button
- Demo slug: interactive
- Title: heroui-close-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/heroui-close-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__heroui-close-button__interactive.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__heroui-close-button__interactive.png
