...
- Source page: https://21st.dev/community/components/tailark/footer/footer-advanced
- Registry URL: https://21st.dev/r/tailark/footer
- Author: tailark
- Component slug: footer
- Demo slug: footer-advanced
- Title: footer
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tailark/footer with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tailark__footer__footer-advanced.html
- Local screenshot file: generated-21st-prompts/screenshots/tailark__footer__footer-advanced.png
