...
- Source page: https://21st.dev/community/components/haik-kashiyani/executive-impact-carousel/default
- Registry URL: https://21st.dev/r/haik-kashiyani/executive-impact-carousel
- Author: haik-kashiyani
- Component slug: executive-impact-carousel
- Demo slug: default
- Title: executive-impact-carousel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/haik-kashiyani/executive-impact-carousel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/haik-kashiyani__executive-impact-carousel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/haik-kashiyani__executive-impact-carousel__default.png
