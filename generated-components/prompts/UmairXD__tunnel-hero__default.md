...
- Source page: https://21st.dev/community/components/UmairXD/tunnel-hero/default
- Registry URL: https://21st.dev/r/UmairXD/tunnel-hero
- Author: UmairXD
- Component slug: tunnel-hero
- Demo slug: default
- Title: tunnel-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/UmairXD/tunnel-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/UmairXD__tunnel-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/UmairXD__tunnel-hero__default.png
