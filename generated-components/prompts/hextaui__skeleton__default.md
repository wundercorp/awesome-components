...
- Source page: https://21st.dev/community/components/hextaui/skeleton/default
- Registry URL: https://21st.dev/r/hextaui/skeleton
- Author: hextaui
- Component slug: skeleton
- Demo slug: default
- Title: skeleton
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/skeleton with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__skeleton__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__skeleton__default.png
