...
- Source page: https://21st.dev/community/components/bucharitesh/view-magnifier/default
- Registry URL: https://21st.dev/r/bucharitesh/view-magnifier
- Author: bucharitesh
- Component slug: view-magnifier
- Demo slug: default
- Title: view-magnifier
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/bucharitesh/view-magnifier with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/bucharitesh__view-magnifier__default.html
- Local screenshot file: generated-21st-prompts/screenshots/bucharitesh__view-magnifier__default.png
