...
- Source page: https://21st.dev/community/components/uniquesonu/shimmer-button/default
- Registry URL: https://21st.dev/r/uniquesonu/shimmer-button
- Author: uniquesonu
- Component slug: shimmer-button
- Demo slug: default
- Title: shimmer-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/shimmer-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__shimmer-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__shimmer-button__default.png
