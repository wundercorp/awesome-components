...
- Source page: https://21st.dev/community/components/uimix/cta-with-marquee/default
- Registry URL: https://21st.dev/r/uimix/cta-with-marquee
- Author: uimix
- Component slug: cta-with-marquee
- Demo slug: default
- Title: cta-with-marquee
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uimix/cta-with-marquee with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uimix__cta-with-marquee__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uimix__cta-with-marquee__default.png
