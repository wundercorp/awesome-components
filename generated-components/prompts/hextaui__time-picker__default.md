...
- Source page: https://21st.dev/community/components/hextaui/time-picker/default
- Registry URL: https://21st.dev/r/hextaui/time-picker
- Author: hextaui
- Component slug: time-picker
- Demo slug: default
- Title: time-picker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/time-picker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__time-picker__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__time-picker__default.png
