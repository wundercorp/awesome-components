...
- Source page: https://21st.dev/community/components/shadway/crypto-swap-card/default
- Registry URL: https://21st.dev/r/shadway/crypto-swap-card
- Author: shadway
- Component slug: crypto-swap-card
- Demo slug: default
- Title: crypto-swap-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadway/crypto-swap-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadway__crypto-swap-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadway__crypto-swap-card__default.png
