...
- Source page: https://21st.dev/community/components/hextaui/tooltip/default
- Registry URL: https://21st.dev/r/hextaui/tooltip
- Author: hextaui
- Component slug: tooltip
- Demo slug: default
- Title: tooltip
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/tooltip with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__tooltip__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__tooltip__default.png
