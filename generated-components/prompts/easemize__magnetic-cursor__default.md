...
- Source page: https://21st.dev/community/components/easemize/magnetic-cursor/default
- Registry URL: https://21st.dev/r/easemize/magnetic-cursor
- Author: easemize
- Component slug: magnetic-cursor
- Demo slug: default
- Title: magnetic-cursor
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/magnetic-cursor with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__magnetic-cursor__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__magnetic-cursor__default.png
