...
- Source page: https://21st.dev/community/components/isaiahbjork/gradient-selector-card/default
- Registry URL: https://21st.dev/r/isaiahbjork/gradient-selector-card
- Author: isaiahbjork
- Component slug: gradient-selector-card
- Demo slug: default
- Title: gradient-selector-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/isaiahbjork/gradient-selector-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/isaiahbjork__gradient-selector-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/isaiahbjork__gradient-selector-card__default.png
