...
- Source page: https://21st.dev/community/components/aceternity/squiggly-underline/default
- Registry URL: https://21st.dev/r/aceternity/squiggly-underline
- Author: aceternity
- Component slug: squiggly-underline
- Demo slug: default
- Title: squiggly-underline
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/squiggly-underline with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__squiggly-underline__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__squiggly-underline__default.png
