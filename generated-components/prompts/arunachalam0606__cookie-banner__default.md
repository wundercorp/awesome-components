...
- Source page: https://21st.dev/community/components/arunachalam0606/cookie-banner/default
- Registry URL: https://21st.dev/r/arunachalam0606/cookie-banner
- Author: arunachalam0606
- Component slug: cookie-banner
- Demo slug: default
- Title: cookie-banner
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arunachalam0606/cookie-banner with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arunachalam0606__cookie-banner__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arunachalam0606__cookie-banner__default.png
