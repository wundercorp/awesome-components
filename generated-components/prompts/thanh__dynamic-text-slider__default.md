...
- Source page: https://21st.dev/community/components/thanh/dynamic-text-slider/default
- Registry URL: https://21st.dev/r/thanh/dynamic-text-slider
- Author: thanh
- Component slug: dynamic-text-slider
- Demo slug: default
- Title: dynamic-text-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/dynamic-text-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__dynamic-text-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__dynamic-text-slider__default.png
