...
- Source page: https://21st.dev/community/components/RuvyUI/loading-lines/default
- Registry URL: https://21st.dev/r/RuvyUI/loading-lines
- Author: RuvyUI
- Component slug: loading-lines
- Demo slug: default
- Title: loading-lines
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/RuvyUI/loading-lines with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/RuvyUI__loading-lines__default.html
- Local screenshot file: generated-21st-prompts/screenshots/RuvyUI__loading-lines__default.png
