...
- Source page: https://21st.dev/community/components/animate-ui/stars-scrolling-wheel/default
- Registry URL: https://21st.dev/r/animate-ui/stars-scrolling-wheel
- Author: animate-ui
- Component slug: stars-scrolling-wheel
- Demo slug: default
- Title: stars-scrolling-wheel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/animate-ui/stars-scrolling-wheel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/animate-ui__stars-scrolling-wheel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/animate-ui__stars-scrolling-wheel__default.png
