...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-picker/controlled
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-picker__controlled.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-picker__controlled.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex w-64 flex-col gap-4"><div data-slot="date-picker" class="date-picker w-64" data-rac=""><style>
