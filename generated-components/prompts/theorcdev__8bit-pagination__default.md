...
- Source page: https://21st.dev/community/components/theorcdev/8bit-pagination/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-pagination
- Author: theorcdev
- Component slug: 8bit-pagination
- Demo slug: default
- Title: 8bit-pagination
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-pagination with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-pagination__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-pagination__default.png
