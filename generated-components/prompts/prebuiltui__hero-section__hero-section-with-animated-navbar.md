...
- Source page: https://21st.dev/community/components/prebuiltui/hero-section/hero-section-with-animated-navbar
- Registry URL: https://21st.dev/r/prebuiltui/hero-section
- Author: prebuiltui
- Component slug: hero-section
- Demo slug: hero-section-with-animated-navbar
- Title: hero-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/prebuiltui/hero-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/prebuiltui__hero-section__hero-section-with-animated-navbar.html
- Local screenshot file: generated-21st-prompts/screenshots/prebuiltui__hero-section__hero-section-with-animated-navbar.png
