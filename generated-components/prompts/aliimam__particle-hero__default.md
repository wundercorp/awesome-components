...
- Source page: https://21st.dev/community/components/aliimam/particle-hero/default
- Registry URL: https://21st.dev/r/aliimam/particle-hero
- Author: aliimam
- Component slug: particle-hero
- Demo slug: default
- Title: particle-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/particle-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__particle-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__particle-hero__default.png
