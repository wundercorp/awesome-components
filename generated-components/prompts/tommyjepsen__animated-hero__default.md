...
- Source page: https://21st.dev/community/components/tommyjepsen/animated-hero/default
- Registry URL: https://21st.dev/r/tommyjepsen/animated-hero
- Author: tommyjepsen
- Component slug: animated-hero
- Demo slug: default
- Title: animated-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tommyjepsen/animated-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tommyjepsen__animated-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tommyjepsen__animated-hero__default.png
