...
- Source page: https://21st.dev/community/components/coss.com/frame/separated-panels
- Registry URL: https://21st.dev/r/coss.com/frame
- Author: coss.com
- Component slug: frame
- Demo slug: separated-panels
- Title: frame
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/coss.com/frame with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/coss.com__frame__separated-panels.html
- Local screenshot file: generated-21st-prompts/screenshots/coss.com__frame__separated-panels.png
