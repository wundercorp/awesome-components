...
- Source page: https://21st.dev/community/components/mapcn/mapcn-map/custom-styles
- Registry URL: https://21st.dev/r/mapcn/mapcn-map
- Author: mapcn
- Component slug: mapcn-map
- Demo slug: custom-styles
- Title: mapcn-map
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/mapcn/mapcn-map with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/mapcn__mapcn-map__custom-styles.html
- Local screenshot file: generated-21st-prompts/screenshots/mapcn__mapcn-map__custom-styles.png
