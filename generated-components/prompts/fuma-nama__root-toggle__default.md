...
- Source page: https://21st.dev/community/components/fuma-nama/root-toggle/default
- Registry URL: https://21st.dev/r/fuma-nama/root-toggle
- Author: fuma-nama
- Component slug: root-toggle
- Demo slug: default
- Title: root-toggle
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/fuma-nama/root-toggle with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/fuma-nama__root-toggle__default.html
- Local screenshot file: generated-21st-prompts/screenshots/fuma-nama__root-toggle__default.png
