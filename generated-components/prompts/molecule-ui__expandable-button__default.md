...
- Source page: https://21st.dev/community/components/molecule-ui/expandable-button/default
- Registry URL: https://21st.dev/r/molecule-ui/expandable-button
- Author: molecule-ui
- Component slug: expandable-button
- Demo slug: default
- Title: expandable-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/molecule-ui/expandable-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/molecule-ui__expandable-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/molecule-ui__expandable-button__default.png
