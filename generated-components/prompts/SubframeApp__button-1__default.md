...
- Source page: https://21st.dev/community/components/SubframeApp/button-1/default
- Registry URL: https://21st.dev/r/SubframeApp/button-1
- Author: SubframeApp
- Component slug: button-1
- Demo slug: default
- Title: button-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/SubframeApp/button-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/SubframeApp__button-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/SubframeApp__button-1__default.png
