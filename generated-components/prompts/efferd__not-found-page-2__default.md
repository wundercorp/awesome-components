...
- Source page: https://21st.dev/community/components/efferd/not-found-page-2/default
- Registry URL: https://21st.dev/r/efferd/not-found-page-2
- Author: efferd
- Component slug: not-found-page-2
- Demo slug: default
- Title: not-found-page-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/efferd/not-found-page-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/efferd__not-found-page-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/efferd__not-found-page-2__default.png
