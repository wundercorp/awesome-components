...
- Source page: https://21st.dev/community/components/YoucefBnm/story/default
- Registry URL: https://21st.dev/r/YoucefBnm/story
- Author: YoucefBnm
- Component slug: story
- Demo slug: default
- Title: story
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/YoucefBnm/story with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/YoucefBnm__story__default.html
- Local screenshot file: generated-21st-prompts/screenshots/YoucefBnm__story__default.png
