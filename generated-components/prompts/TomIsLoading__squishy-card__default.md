...
- Source page: https://21st.dev/community/components/TomIsLoading/squishy-card/default
- Registry URL: https://21st.dev/r/TomIsLoading/squishy-card
- Author: TomIsLoading
- Component slug: squishy-card
- Demo slug: default
- Title: squishy-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/TomIsLoading/squishy-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/TomIsLoading__squishy-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/TomIsLoading__squishy-card__default.png
