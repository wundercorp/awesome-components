...
- Source page: https://21st.dev/community/components/cnippet_dev/button/default
- Registry URL: https://21st.dev/r/cnippet_dev/button
- Author: cnippet_dev
- Component slug: button
- Demo slug: default
- Title: button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/cnippet_dev/button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/cnippet_dev__button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/cnippet_dev__button__default.png
