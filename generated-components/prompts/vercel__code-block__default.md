...
- Source page: https://21st.dev/community/components/vercel/code-block/default
- Registry URL: https://21st.dev/r/vercel/code-block
- Author: vercel
- Component slug: code-block
- Demo slug: default
- Title: code-block
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/vercel/code-block with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/vercel__code-block__default.html
- Local screenshot file: generated-21st-prompts/screenshots/vercel__code-block__default.png
