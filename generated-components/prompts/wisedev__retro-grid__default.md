...
- Source page: https://21st.dev/community/components/wisedev/retro-grid/default
- Registry URL: https://21st.dev/r/wisedev/retro-grid
- Author: wisedev
- Component slug: retro-grid
- Demo slug: default
- Title: retro-grid
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/wisedev/retro-grid with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/wisedev__retro-grid__default.html
- Local screenshot file: generated-21st-prompts/screenshots/wisedev__retro-grid__default.png
