...
- Source page: https://21st.dev/community/components/mapcn/mapcn-map-cluster-layer/default
- Registry URL: https://21st.dev/r/mapcn/mapcn-map-cluster-layer
- Author: mapcn
- Component slug: mapcn-map-cluster-layer
- Demo slug: default
- Title: mapcn-map-cluster-layer
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/mapcn/mapcn-map-cluster-layer with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/mapcn__mapcn-map-cluster-layer__default.html
- Local screenshot file: generated-21st-prompts/screenshots/mapcn__mapcn-map-cluster-layer__default.png
