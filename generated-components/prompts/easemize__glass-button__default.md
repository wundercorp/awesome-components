...
- Source page: https://21st.dev/community/components/easemize/glass-button/default
- Registry URL: https://21st.dev/r/easemize/glass-button
- Author: easemize
- Component slug: glass-button
- Demo slug: default
- Title: glass-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/glass-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__glass-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__glass-button__default.png
