...
- Source page: https://21st.dev/community/components/ruixenui/job-card/default
- Registry URL: https://21st.dev/r/ruixenui/job-card
- Author: ruixenui
- Component slug: job-card
- Demo slug: default
- Title: job-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/job-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__job-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__job-card__default.png
