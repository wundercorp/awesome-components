...
- Source page: https://21st.dev/community/components/shugar/checkbox/default
- Registry URL: https://21st.dev/r/shugar/checkbox
- Author: shugar
- Component slug: checkbox
- Demo slug: default
- Title: checkbox
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/checkbox with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__checkbox__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__checkbox__default.png
