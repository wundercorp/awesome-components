...
- Source page: https://21st.dev/community/components/ravikatiyar/feature-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/feature-card
- Author: ravikatiyar
- Component slug: feature-card
- Demo slug: default
- Title: feature-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/feature-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__feature-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__feature-card__default.png
