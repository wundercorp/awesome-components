...
- Source page: https://21st.dev/community/components/reapollo/heroui-color-picker/with-sliders
- Registry URL: https://21st.dev/r/reapollo/heroui-color-picker
- Author: reapollo
- Component slug: heroui-color-picker
- Demo slug: with-sliders
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__heroui-color-picker__with-sliders.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__heroui-color-picker__with-sliders.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><style>
    ...
    </style><div class="color-picker" data-slot="color-picker"><button type="button" class="color-picker__trigger" aria-expanded="true" data-slot="color-picker-trigger"><span class="color-swatch color-swatch--lg" data-slot="color-swatch" style="--swatch-color: rgb(227, 234, 248); border-radius: 0.6rem;"></span><label class="label" data-slot="label">Pick a color</label></button><div class="color-picker__popover max-w-62 gap-2 px-2 py-3" data-slot="color-picker-popover"><div class="select"><button type="button" class="select__trigger"><span class="uppercase">hsl</span><span aria-hidden="true">⌄</span></button></div><div class="flex flex-col gap-2"><div class="color-slider gap-1 px-1" data-slot="color-slider" aria-label="hue"><label class="label capitalize" data-slot="label">hue</label><span class="color-slider__output text-muted">219°</span><div class="color-slider__track" data-slot="color-slider-track" style="--track-bg: linear-gradient(to right, rgb(255,0,0), rgb(255,255,0), rgb(0,255,0), rgb(0,255,255), rgb(0,0,255), rgb(255,0,255), rgb(255,0,0)); --percent: 60.83333333333333;"><div role="slider" tabindex="0" aria-label="hue" aria-valuemin="0" aria-valuemax="360" aria-valuenow="219" class="color-slider__thumb" data-slot="color-slider-thumb" style="--percent: 60.83333333333333; --thumb-color: rgb(227, 234, 248);"></div></div></div><div class="color-slider gap-1 px-1" data-slot="color-slider" aria-label="saturation"><label class="label capitalize" data-slot="label">saturation</label><span class="color-slider__output text-muted">8%</span><div class="color-slider__track" data-slot="color-slider-track" style="--track-bg: linear-gradient(to right, hsl(219 0% 50%), hsl(219 100% 50%)); --percent: 8.365959200494544;"><div role="slider" tabindex="0" aria-label="saturation" aria-valuemin="0" aria-valuemax="100" aria-valuenow="8" class="color-slider__thumb" data-slot="color-slider-thumb" style="--percent: 8.365959200494544; --thumb-color: rgb(227, 234, 248);"></div></div></div><div class="color-slider gap-1 px-1" data-slot="color-slider" aria-label="lightness"><label class="label capitalize" data-slot="label">lightness</label><span class="color-slider__output text-muted">93%</span><div class="color-slider__track" data-slot="color-slider-track" style="--track-bg: linear-gradient(to right, black, hsl(219 8% 50%), white); --percent: 93;"><div role="slider" tabindex="0" aria-label="lightness" aria-valuemin="0" aria-valuemax="100" aria-valuenow="93" class="color-slider__thumb" data-slot="color-slider-thumb" style="--percent: 93; --thumb-color: rgb(227, 234, 248);"></div></div></div><div class="color-slider gap-1 px-1" data-slot="color-slider" aria-label="alpha"><label class="label capitalize" data-slot="label">alpha</label><span class="color-slider__output text-muted">100%</span><div class="color-slider__track" data-slot="color-slider-track" style="--track-bg: linear-gradient(to right, transparent, rgb(227, 234, 248)); --percent: 100;"><div role="slider" tabindex="0" aria-label="alpha" aria-valuemin="0" aria-valuemax="1" aria-valuenow="1" class="color-slider__thumb" data-slot="color-slider-thumb" style="--percent: 100; --thumb-color: rgb(227, 234, 248);"></div></div></div></div></div></div></div></div>
```
