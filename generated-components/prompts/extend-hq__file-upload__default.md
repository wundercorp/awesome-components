...
- Source page: https://21st.dev/community/components/extend-hq/file-upload/default
- Registry URL: https://21st.dev/r/extend-hq/file-upload
- Author: extend-hq
- Component slug: file-upload
- Demo slug: default
- Title: file-upload
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/extend-hq/file-upload with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/extend-hq__file-upload__default.html
- Local screenshot file: generated-21st-prompts/screenshots/extend-hq__file-upload__default.png
