...
- Source page: https://21st.dev/community/components/hextaui/sidebar/default
- Registry URL: https://21st.dev/r/hextaui/sidebar
- Author: hextaui
- Component slug: sidebar
- Demo slug: default
- Title: sidebar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hextaui/sidebar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hextaui__sidebar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hextaui__sidebar__default.png
