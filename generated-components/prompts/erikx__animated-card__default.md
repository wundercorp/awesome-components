...
- Source page: https://21st.dev/community/components/erikx/animated-card/default
- Registry URL: https://21st.dev/r/erikx/animated-card
- Author: erikx
- Component slug: animated-card
- Demo slug: default
- Title: animated-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/animated-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__animated-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__animated-card__default.png
