...
- Source page: https://21st.dev/community/components/extend-hq/select/default
- Registry URL: https://21st.dev/r/extend-hq/select
- Author: extend-hq
- Component slug: select
- Demo slug: default
- Title: select
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/extend-hq/select with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/extend-hq__select__default.html
- Local screenshot file: generated-21st-prompts/screenshots/extend-hq__select__default.png
