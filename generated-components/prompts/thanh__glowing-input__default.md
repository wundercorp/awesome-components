...
- Source page: https://21st.dev/community/components/thanh/glowing-input/default
- Registry URL: https://21st.dev/r/thanh/glowing-input
- Author: thanh
- Component slug: glowing-input
- Demo slug: default
- Title: glowing-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/glowing-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__glowing-input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__glowing-input__default.png
