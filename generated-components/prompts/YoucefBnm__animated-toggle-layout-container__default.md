...
- Source page: https://21st.dev/community/components/YoucefBnm/animated-toggle-layout-container/default
- Registry URL: https://21st.dev/r/YoucefBnm/animated-toggle-layout-container
- Author: YoucefBnm
- Component slug: animated-toggle-layout-container
- Demo slug: default
- Title: animated-toggle-layout-container
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/YoucefBnm/animated-toggle-layout-container with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/YoucefBnm__animated-toggle-layout-container__default.html
- Local screenshot file: generated-21st-prompts/screenshots/YoucefBnm__animated-toggle-layout-container__default.png
