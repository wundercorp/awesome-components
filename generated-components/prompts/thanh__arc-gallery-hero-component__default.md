...
- Source page: https://21st.dev/community/components/thanh/arc-gallery-hero-component/default
- Registry URL: https://21st.dev/r/thanh/arc-gallery-hero-component
- Author: thanh
- Component slug: arc-gallery-hero-component
- Demo slug: default
- Title: arc-gallery-hero-component
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/arc-gallery-hero-component with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__arc-gallery-hero-component__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__arc-gallery-hero-component__default.png
