...
- Source page: https://21st.dev/community/components/cnippet_dev/aero-hero-2/default
- Registry URL: https://21st.dev/r/cnippet_dev/aero-hero-2
- Author: cnippet_dev
- Component slug: aero-hero-2
- Demo slug: default
- Title: aero-hero-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/cnippet_dev/aero-hero-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/cnippet_dev__aero-hero-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/cnippet_dev__aero-hero-2__default.png
