...
- Source page: https://21st.dev/community/components/kavikatiyar/testimonial-slider/default
- Registry URL: https://21st.dev/r/kavikatiyar/testimonial-slider
- Author: kavikatiyar
- Component slug: testimonial-slider
- Demo slug: default
- Title: testimonial-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/testimonial-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__testimonial-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__testimonial-slider__default.png
