...
- Source page: https://21st.dev/community/components/kavikatiyar/chat-bubble/default
- Registry URL: https://21st.dev/r/kavikatiyar/chat-bubble
- Author: kavikatiyar
- Component slug: chat-bubble
- Demo slug: default
- Title: chat-bubble
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/chat-bubble with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__chat-bubble__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__chat-bubble__default.png
