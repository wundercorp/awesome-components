...
- Source page: https://21st.dev/community/components/Codehagen/hero-pill/default
- Registry URL: https://21st.dev/r/Codehagen/hero-pill
- Author: Codehagen
- Component slug: hero-pill
- Demo slug: default
- Title: hero-pill
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Codehagen/hero-pill with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Codehagen__hero-pill__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Codehagen__hero-pill__default.png
