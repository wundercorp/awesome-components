...
- Source page: https://21st.dev/community/components/lavikatiyar/image-uploader/default
- Registry URL: https://21st.dev/r/lavikatiyar/image-uploader
- Author: lavikatiyar
- Component slug: image-uploader
- Demo slug: default
- Title: image-uploader
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/image-uploader with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__image-uploader__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__image-uploader__default.png
