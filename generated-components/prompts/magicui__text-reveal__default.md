...
- Source page: https://21st.dev/community/components/magicui/text-reveal/default
- Registry URL: https://21st.dev/r/magicui/text-reveal
- Author: magicui
- Component slug: text-reveal
- Demo slug: default
- Title: text-reveal
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/magicui/text-reveal with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/magicui__text-reveal__default.html
- Local screenshot file: generated-21st-prompts/screenshots/magicui__text-reveal__default.png
