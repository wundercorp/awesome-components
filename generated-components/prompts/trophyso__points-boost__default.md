...
- Source page: https://21st.dev/community/components/trophyso/points-boost/default
- Registry URL: https://21st.dev/r/trophyso/points-boost
- Author: trophyso
- Component slug: points-boost
- Demo slug: default
- Title: points-boost
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/trophyso/points-boost with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/trophyso__points-boost__default.html
- Local screenshot file: generated-21st-prompts/screenshots/trophyso__points-boost__default.png
