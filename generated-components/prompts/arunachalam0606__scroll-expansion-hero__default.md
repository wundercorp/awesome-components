...
- Source page: https://21st.dev/community/components/arunachalam0606/scroll-expansion-hero/default
- Registry URL: https://21st.dev/r/arunachalam0606/scroll-expansion-hero
- Author: arunachalam0606
- Component slug: scroll-expansion-hero
- Demo slug: default
- Title: scroll-expansion-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arunachalam0606/scroll-expansion-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arunachalam0606__scroll-expansion-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arunachalam0606__scroll-expansion-hero__default.png
