...
- Source page: https://21st.dev/community/components/ruixenui/notifications-carousel/default
- Registry URL: https://21st.dev/r/ruixenui/notifications-carousel
- Author: ruixenui
- Component slug: notifications-carousel
- Demo slug: default
- Title: notifications-carousel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/notifications-carousel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__notifications-carousel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__notifications-carousel__default.png
