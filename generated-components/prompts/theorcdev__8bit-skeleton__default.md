...
- Source page: https://21st.dev/community/components/theorcdev/8bit-skeleton/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-skeleton
- Author: theorcdev
- Component slug: 8bit-skeleton
- Demo slug: default
- Title: 8bit-skeleton
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-skeleton with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-skeleton__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-skeleton__default.png
