...
- Source page: https://21st.dev/community/components/ravikatiyar/modern-hero-section/default
- Registry URL: https://21st.dev/r/ravikatiyar/modern-hero-section
- Author: ravikatiyar
- Component slug: modern-hero-section
- Demo slug: default
- Title: modern-hero-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/modern-hero-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__modern-hero-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__modern-hero-section__default.png
