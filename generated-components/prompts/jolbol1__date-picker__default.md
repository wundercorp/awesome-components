...
- Source page: https://21st.dev/community/components/jolbol1/date-picker/default
- Registry URL: https://21st.dev/r/jolbol1/date-picker
- Author: jolbol1
- Component slug: date-picker
- Demo slug: default
- Title: date-picker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jolbol1/date-picker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jolbol1__date-picker__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jolbol1__date-picker__default.png
