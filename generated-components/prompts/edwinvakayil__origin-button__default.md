...
- Source page: https://21st.dev/community/components/edwinvakayil/origin-button/default
- Registry URL: https://21st.dev/r/edwinvakayil/origin-button
- Author: edwinvakayil
- Component slug: origin-button
- Demo slug: default
- Title: origin-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/origin-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__origin-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__origin-button__default.png
