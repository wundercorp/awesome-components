...
- Source page: https://21st.dev/community/components/hero_ui/heroui-description/text-field
- Registry URL: https://21st.dev/r/hero_ui/heroui-description
- Author: hero_ui
- Component slug: heroui-description
- Demo slug: text-field
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-description__text-field.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-description__text-field.png
...
</style><div class="heroui-description-field"><label class="label heroui-description-label" for="heroui-text-field-_r_0_">Email</label><input class="input input--primary heroui-description-input" aria-describedby="heroui-text-field-_r_0_-description" id="heroui-text-field-_r_0_" placeholder="Enter your email" type="email"><span class="description heroui-description-description" data-slot="description" slot="description" id="heroui-text-field-_r_0_-description">We'll never share your email</span></div></div></div>
```
