...
- Source page: https://21st.dev/community/components/YadHakim/rotating-text/default
- Registry URL: https://21st.dev/r/YadHakim/rotating-text
- Author: YadHakim
- Component slug: rotating-text
- Demo slug: default
- Title: rotating-text
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/YadHakim/rotating-text with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/YadHakim__rotating-text__default.html
- Local screenshot file: generated-21st-prompts/screenshots/YadHakim__rotating-text__default.png
