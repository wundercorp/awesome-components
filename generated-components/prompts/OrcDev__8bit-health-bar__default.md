...
- Source page: https://21st.dev/community/components/OrcDev/8bit-health-bar/default
- Registry URL: https://21st.dev/r/OrcDev/8bit-health-bar
- Author: OrcDev
- Component slug: 8bit-health-bar
- Demo slug: default
- Title: 8bit-health-bar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/OrcDev/8bit-health-bar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/OrcDev__8bit-health-bar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/OrcDev__8bit-health-bar__default.png
