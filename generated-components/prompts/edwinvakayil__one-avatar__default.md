...
- Source page: https://21st.dev/community/components/edwinvakayil/one-avatar/default
- Registry URL: https://21st.dev/r/edwinvakayil/one-avatar
- Author: edwinvakayil
- Component slug: one-avatar
- Demo slug: default
- Title: one-avatar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/one-avatar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__one-avatar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__one-avatar__default.png
