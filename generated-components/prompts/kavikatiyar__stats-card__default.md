...
- Source page: https://21st.dev/community/components/kavikatiyar/stats-card/default
- Registry URL: https://21st.dev/r/kavikatiyar/stats-card
- Author: kavikatiyar
- Component slug: stats-card
- Demo slug: default
- Title: stats-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/stats-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__stats-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__stats-card__default.png
