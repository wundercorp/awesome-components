...
- Source page: https://21st.dev/community/components/ln-dev7/mega-menu/default
- Registry URL: https://21st.dev/r/ln-dev7/mega-menu
- Author: ln-dev7
- Component slug: mega-menu
- Demo slug: default
- Title: mega-menu
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ln-dev7/mega-menu with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ln-dev7__mega-menu__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ln-dev7__mega-menu__default.png
