...
- Source page: https://21st.dev/community/components/tailark/pricing-base/pricing-one
- Registry URL: https://21st.dev/r/tailark/pricing-base
- Author: tailark
- Component slug: pricing-base
- Demo slug: pricing-one
- Title: pricing-base
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tailark/pricing-base with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tailark__pricing-base__pricing-one.html
- Local screenshot file: generated-21st-prompts/screenshots/tailark__pricing-base__pricing-one.png
