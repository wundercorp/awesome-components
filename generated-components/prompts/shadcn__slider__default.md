...
- Source page: https://21st.dev/community/components/shadcn/slider/default
- Registry URL: https://21st.dev/r/shadcn/slider
- Author: shadcn
- Component slug: slider
- Demo slug: default
- Title: slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__slider__default.png
