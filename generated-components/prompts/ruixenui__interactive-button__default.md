...
- Source page: https://21st.dev/community/components/ruixenui/interactive-button/default
- Registry URL: https://21st.dev/r/ruixenui/interactive-button
- Author: ruixenui
- Component slug: interactive-button
- Demo slug: default
- Title: interactive-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/interactive-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__interactive-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__interactive-button__default.png
