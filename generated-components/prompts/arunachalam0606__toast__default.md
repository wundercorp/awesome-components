...
- Source page: https://21st.dev/community/components/arunachalam0606/toast/default
- Registry URL: https://21st.dev/r/arunachalam0606/toast
- Author: arunachalam0606
- Component slug: toast
- Demo slug: default
- Title: toast
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arunachalam0606/toast with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arunachalam0606__toast__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arunachalam0606__toast__default.png
