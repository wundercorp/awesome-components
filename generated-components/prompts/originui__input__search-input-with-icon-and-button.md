...
- Source page: https://21st.dev/community/components/originui/input/search-input-with-icon-and-button
- Registry URL: https://21st.dev/r/originui/input
- Author: originui
- Component slug: input
- Demo slug: search-input-with-icon-and-button
- Title: input
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/originui__input__search-input-with-icon-and-button.html
- Local screenshot file: generated-21st-prompts/screenshots/originui__input__search-input-with-icon-and-button.png
