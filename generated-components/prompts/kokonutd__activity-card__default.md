...
- Source page: https://21st.dev/community/components/kokonutd/activity-card/default
- Registry URL: https://21st.dev/r/kokonutd/activity-card
- Author: kokonutd
- Component slug: activity-card
- Demo slug: default
- Title: activity-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kokonutd/activity-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kokonutd__activity-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kokonutd__activity-card__default.png
