...
- Source page: https://21st.dev/community/components/appvibed01/auth-switch/auth-switch
- Registry URL: https://21st.dev/r/appvibed01/auth-switch
- Author: appvibed01
- Component slug: auth-switch
- Demo slug: auth-switch
- Title: auth-switch
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/appvibed01/auth-switch with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/appvibed01__auth-switch__auth-switch.html
- Local screenshot file: generated-21st-prompts/screenshots/appvibed01__auth-switch__auth-switch.png
