...
- Source page: https://21st.dev/community/components/tom_ui/label-input/default
- Registry URL: https://21st.dev/r/tom_ui/label-input
- Author: tom_ui
- Component slug: label-input
- Demo slug: default
- Title: label-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tom_ui/label-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tom_ui__label-input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tom_ui__label-input__default.png
