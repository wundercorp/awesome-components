...
- Source page: https://21st.dev/community/components/dhiluxui/dynamic-waveform/default
- Registry URL: https://21st.dev/r/dhiluxui/dynamic-waveform
- Author: dhiluxui
- Component slug: dynamic-waveform
- Demo slug: default
- Title: dynamic-waveform
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/dynamic-waveform with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__dynamic-waveform__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__dynamic-waveform__default.png
