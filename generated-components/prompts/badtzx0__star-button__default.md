...
- Source page: https://21st.dev/community/components/badtzx0/star-button/default
- Registry URL: https://21st.dev/r/badtzx0/star-button
- Author: badtzx0
- Component slug: star-button
- Demo slug: default
- Title: star-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/badtzx0/star-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/badtzx0__star-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/badtzx0__star-button__default.png
