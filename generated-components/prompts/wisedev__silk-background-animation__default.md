...
- Source page: https://21st.dev/community/components/wisedev/silk-background-animation/default
- Registry URL: https://21st.dev/r/wisedev/silk-background-animation
- Author: wisedev
- Component slug: silk-background-animation
- Demo slug: default
- Title: silk-background-animation
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/wisedev/silk-background-animation with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/wisedev__silk-background-animation__default.html
- Local screenshot file: generated-21st-prompts/screenshots/wisedev__silk-background-animation__default.png
