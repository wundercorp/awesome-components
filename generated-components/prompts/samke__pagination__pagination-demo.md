...
- Source page: https://21st.dev/community/components/samke/pagination/pagination-demo
- Registry URL: https://21st.dev/r/samke/pagination
- Author: samke
- Component slug: pagination
- Demo slug: pagination-demo
- Title: pagination
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/samke/pagination with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/samke__pagination__pagination-demo.html
- Local screenshot file: generated-21st-prompts/screenshots/samke__pagination__pagination-demo.png
