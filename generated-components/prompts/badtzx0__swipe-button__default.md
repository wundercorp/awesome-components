...
- Source page: https://21st.dev/community/components/badtzx0/swipe-button/default
- Registry URL: https://21st.dev/r/badtzx0/swipe-button
- Author: badtzx0
- Component slug: swipe-button
- Demo slug: default
- Title: swipe-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/badtzx0/swipe-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/badtzx0__swipe-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/badtzx0__swipe-button__default.png
