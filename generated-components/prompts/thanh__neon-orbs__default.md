...
- Source page: https://21st.dev/community/components/thanh/neon-orbs/default
- Registry URL: https://21st.dev/r/thanh/neon-orbs
- Author: thanh
- Component slug: neon-orbs
- Demo slug: default
- Title: neon-orbs
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/neon-orbs with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__neon-orbs__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__neon-orbs__default.png
