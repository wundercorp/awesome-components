...
- Source page: https://21st.dev/community/components/dhiluxui/sketchbook-reveal-card/default
- Registry URL: https://21st.dev/r/dhiluxui/sketchbook-reveal-card
- Author: dhiluxui
- Component slug: sketchbook-reveal-card
- Demo slug: default
- Title: sketchbook-reveal-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/sketchbook-reveal-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__sketchbook-reveal-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__sketchbook-reveal-card__default.png
