...
- Source page: https://21st.dev/community/components/shugar/choicebox/choicebox
- Registry URL: https://21st.dev/r/shugar/choicebox
- Author: shugar
- Component slug: choicebox
- Demo slug: choicebox
- Title: choicebox
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/choicebox with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__choicebox__choicebox.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__choicebox__choicebox.png
