...
- Source page: https://21st.dev/community/components/YoucefBnm/flip-card/flip-card
- Registry URL: https://21st.dev/r/YoucefBnm/flip-card
- Author: YoucefBnm
- Component slug: flip-card
- Demo slug: flip-card
- Title: flip-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/YoucefBnm/flip-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/YoucefBnm__flip-card__flip-card.html
- Local screenshot file: generated-21st-prompts/screenshots/YoucefBnm__flip-card__flip-card.png
