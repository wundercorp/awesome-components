...
- Source page: https://21st.dev/community/components/danielpetho/use-screen-size/default
- Registry URL: https://21st.dev/r/danielpetho/use-screen-size
- Author: danielpetho
- Component slug: use-screen-size
- Demo slug: default
- Title: use-screen-size
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/use-screen-size with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__use-screen-size__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__use-screen-size__default.png
