...
- Source page: https://21st.dev/community/components/ui-layouts/linear-card/default
- Registry URL: https://21st.dev/r/ui-layouts/linear-card
- Author: ui-layouts
- Component slug: linear-card
- Demo slug: default
- Title: linear-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/linear-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__linear-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__linear-card__default.png
