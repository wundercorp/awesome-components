...
- Source page: https://21st.dev/community/components/arunachalam0606/animated-table/default
- Registry URL: https://21st.dev/r/arunachalam0606/animated-table
- Author: arunachalam0606
- Component slug: animated-table
- Demo slug: default
- Title: animated-table
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/arunachalam0606/animated-table with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/arunachalam0606__animated-table__default.html
- Local screenshot file: generated-21st-prompts/screenshots/arunachalam0606__animated-table__default.png
