...
- Source page: https://21st.dev/community/components/thanh/parallax-scrolling-effect/default
- Registry URL: https://21st.dev/r/thanh/parallax-scrolling-effect
- Author: thanh
- Component slug: parallax-scrolling-effect
- Demo slug: default
- Title: parallax-scrolling-effect
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/parallax-scrolling-effect with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__parallax-scrolling-effect__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__parallax-scrolling-effect__default.png
