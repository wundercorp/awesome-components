...
- Source page: https://21st.dev/community/components/dhiluxui/crystal-shader/default
- Registry URL: https://21st.dev/r/dhiluxui/crystal-shader
- Author: dhiluxui
- Component slug: crystal-shader
- Demo slug: default
- Title: crystal-shader
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/crystal-shader with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__crystal-shader__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__crystal-shader__default.png
