...
- Source page: https://21st.dev/community/components/avanishverma4/otp-input/default
- Registry URL: https://21st.dev/r/avanishverma4/otp-input
- Author: avanishverma4
- Component slug: otp-input
- Demo slug: default
- Title: otp-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/otp-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__otp-input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__otp-input__default.png
