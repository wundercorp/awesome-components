...
- Source page: https://21st.dev/community/components/mapcn/mapcn-marker-tooltip/default
- Registry URL: https://21st.dev/r/mapcn/mapcn-marker-tooltip
- Author: mapcn
- Component slug: mapcn-marker-tooltip
- Demo slug: default
- Title: mapcn-marker-tooltip
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/mapcn/mapcn-marker-tooltip with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/mapcn__mapcn-marker-tooltip__default.html
- Local screenshot file: generated-21st-prompts/screenshots/mapcn__mapcn-marker-tooltip__default.png
