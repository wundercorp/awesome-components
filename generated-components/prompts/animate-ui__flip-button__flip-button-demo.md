...
- Source page: https://21st.dev/community/components/animate-ui/flip-button/flip-button-demo
- Registry URL: https://21st.dev/r/animate-ui/flip-button
- Author: animate-ui
- Component slug: flip-button
- Demo slug: flip-button-demo
- Title: flip-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/animate-ui/flip-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/animate-ui__flip-button__flip-button-demo.html
- Local screenshot file: generated-21st-prompts/screenshots/animate-ui__flip-button__flip-button-demo.png
