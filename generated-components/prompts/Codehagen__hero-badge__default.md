...
- Source page: https://21st.dev/community/components/Codehagen/hero-badge/default
- Registry URL: https://21st.dev/r/Codehagen/hero-badge
- Author: Codehagen
- Component slug: hero-badge
- Demo slug: default
- Title: hero-badge
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Codehagen/hero-badge with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Codehagen__hero-badge__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Codehagen__hero-badge__default.png
