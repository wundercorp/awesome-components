...
- Source page: https://21st.dev/community/components/ruixenui/hero-section-with-gradient/default
- Registry URL: https://21st.dev/r/ruixenui/hero-section-with-gradient
- Author: ruixenui
- Component slug: hero-section-with-gradient
- Demo slug: default
- Title: hero-section-with-gradient
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/hero-section-with-gradient with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__hero-section-with-gradient__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__hero-section-with-gradient__default.png
