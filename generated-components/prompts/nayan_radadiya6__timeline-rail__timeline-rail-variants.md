...
- Source page: https://21st.dev/community/components/nayan_radadiya6/timeline-rail/timeline-rail-variants
- Registry URL: https://21st.dev/r/nayan_radadiya6/timeline-rail
- Author: nayan_radadiya6
- Component slug: timeline-rail
- Demo slug: timeline-rail-variants
- Title: timeline-rail
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/nayan_radadiya6/timeline-rail with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/nayan_radadiya6__timeline-rail__timeline-rail-variants.html
- Local screenshot file: generated-21st-prompts/screenshots/nayan_radadiya6__timeline-rail__timeline-rail-variants.png
