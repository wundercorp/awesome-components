...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-picker/custom-indicator
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-picker__custom-indicator.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-picker__custom-indicator.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div data-slot="date-picker" class="date-picker w-64" data-rac=""><style>
    ...
    </style><span class="label" data-slot="label">Date</span><div data-react-aria-pressable="true" role="group" class="date-input-group date-input-group--full-width date-input-group--primary" data-slot="date-input-group" data-rac=""><div role="presentation" data-react-aria-pressable="true" class="date-input-group__input" data-slot="date-input-group-input" data-rac=""><span data-slot="date-input-group-segment" role="spinbutton" aria-label="month, " data-placeholder="true" contenteditable="true" tabindex="0" class="date-input-group__segment" data-rac="">mm</span><span data-slot="date-input-group-segment" contenteditable="false" class="date-input-group__segment" data-rac="">/</span><span data-slot="date-input-group-segment" role="spinbutton" aria-label="day, " data-placeholder="true" contenteditable="true" tabindex="0" class="date-input-group__segment" data-rac="">dd</span><span data-slot="date-input-group-segment" contenteditable="false" class="date-input-group__segment" data-rac="">/</span><span data-slot="date-input-group-segment" role="spinbutton" aria-label="year, " data-placeholder="true" contenteditable="true" tabindex="0" class="date-input-group__segment" data-rac="">yyyy</span></div><input hidden="" readonly="" type="text" value="" name="date"><div class="date-input-group__suffix" data-slot="date-input-group-suffix"><button data-slot="date-picker-trigger" class="date-picker__trigger" data-rac="" type="button" aria-label="Calendar" aria-haspopup="dialog" aria-expanded="false"><span aria-hidden="true" class="date-picker__trigger-indicator" data-slot="date-picker-trigger-indicator"><svg aria-hidden="true" role="img" class="iconify iconify--gravity-ui size-4" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M2.97 5.47a.75.75 0 0 1 1.06 0L8 9.44l3.97-3.97a.75.75 0 1 1 1.06 1.06l-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5a.75.75 0 0 1 0-1.06" clip-rule="evenodd"></path></svg></span></button></div></div><span class="description" data-slot="description" slot="description">Replace the default calendar icon by passing custom children.</span></div></div></div>
```
