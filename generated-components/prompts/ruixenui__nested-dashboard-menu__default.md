...
- Source page: https://21st.dev/community/components/ruixenui/nested-dashboard-menu/default
- Registry URL: https://21st.dev/r/ruixenui/nested-dashboard-menu
- Author: ruixenui
- Component slug: nested-dashboard-menu
- Demo slug: default
- Title: nested-dashboard-menu
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/nested-dashboard-menu with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__nested-dashboard-menu__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__nested-dashboard-menu__default.png
