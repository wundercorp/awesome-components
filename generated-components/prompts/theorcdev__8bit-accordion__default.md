...
- Source page: https://21st.dev/community/components/theorcdev/8bit-accordion/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-accordion
- Author: theorcdev
- Component slug: 8bit-accordion
- Demo slug: default
- Title: 8bit-accordion
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-accordion with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-accordion__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-accordion__default.png
