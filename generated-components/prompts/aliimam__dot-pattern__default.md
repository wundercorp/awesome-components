...
- Source page: https://21st.dev/community/components/aliimam/dot-pattern/default
- Registry URL: https://21st.dev/r/aliimam/dot-pattern
- Author: aliimam
- Component slug: dot-pattern
- Demo slug: default
- Title: dot-pattern
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/dot-pattern with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__dot-pattern__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__dot-pattern__default.png
