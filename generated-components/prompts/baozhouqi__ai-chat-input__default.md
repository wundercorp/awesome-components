...
- Source page: https://21st.dev/community/components/baozhouqi/ai-chat-input/default
- Registry URL: https://21st.dev/r/baozhouqi/ai-chat-input
- Author: baozhouqi
- Component slug: ai-chat-input
- Demo slug: default
- Title: ai-chat-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/baozhouqi/ai-chat-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/baozhouqi__ai-chat-input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/baozhouqi__ai-chat-input__default.png
