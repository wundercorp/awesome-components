...
- Source page: https://21st.dev/community/components/aceternity/resizable-navbar/default
- Registry URL: https://21st.dev/r/aceternity/resizable-navbar
- Author: aceternity
- Component slug: resizable-navbar
- Demo slug: default
- Title: resizable-navbar
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/resizable-navbar with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__resizable-navbar__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__resizable-navbar__default.png
