...
- Source page: https://21st.dev/community/components/erikx/browser-preview/default
- Registry URL: https://21st.dev/r/erikx/browser-preview
- Author: erikx
- Component slug: browser-preview
- Demo slug: default
- Title: browser-preview
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/browser-preview with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__browser-preview__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__browser-preview__default.png
