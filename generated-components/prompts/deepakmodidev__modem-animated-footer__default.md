...
- Source page: https://21st.dev/community/components/deepakmodidev/modem-animated-footer/default
- Registry URL: https://21st.dev/r/deepakmodidev/modem-animated-footer
- Author: deepakmodidev
- Component slug: modem-animated-footer
- Demo slug: default
- Title: modem-animated-footer
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/deepakmodidev/modem-animated-footer with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/deepakmodidev__modem-animated-footer__default.html
- Local screenshot file: generated-21st-prompts/screenshots/deepakmodidev__modem-animated-footer__default.png
