...
- Source page: https://21st.dev/community/components/ln-dev7/priority-selector/default
- Registry URL: https://21st.dev/r/ln-dev7/priority-selector
- Author: ln-dev7
- Component slug: priority-selector
- Demo slug: default
- Title: priority-selector
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ln-dev7/priority-selector with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ln-dev7__priority-selector__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ln-dev7__priority-selector__default.png
