...
- Source page: https://21st.dev/community/components/uniquesonu/animated-hero-section-ui/default
- Registry URL: https://21st.dev/r/uniquesonu/animated-hero-section-ui
- Author: uniquesonu
- Component slug: animated-hero-section-ui
- Demo slug: default
- Title: animated-hero-section-ui
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/animated-hero-section-ui with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__animated-hero-section-ui__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__animated-hero-section-ui__default.png
