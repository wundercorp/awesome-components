...
- Source page: https://21st.dev/community/components/avanishverma4/hover-image-preview/default
- Registry URL: https://21st.dev/r/avanishverma4/hover-image-preview
- Author: avanishverma4
- Component slug: hover-image-preview
- Demo slug: default
- Title: hover-image-preview
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/hover-image-preview with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__hover-image-preview__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__hover-image-preview__default.png
