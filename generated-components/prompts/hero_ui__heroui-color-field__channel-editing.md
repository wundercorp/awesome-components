...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/channel-editing
- Registry URL: https://21st.dev/r/hero_ui/heroui-color-field
- Author: hero_ui
- Component slug: heroui-color-field
- Demo slug: channel-editing
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__channel-editing.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__channel-editing.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><p class="text-sm text-muted-foreground">Edit individual HSL channels:</p><div class="flex gap-4"><style>
    ...
    </style><div class="color-field w-[100px]" data-slot="color-field" data-channel="hue"><label class="label" data-slot="label" for="_r_0_">Hue</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_0_" inputmode="numeric" spellcheck="false" type="text" value="300°"></div></div><style>
      [data-slot="color-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    </style><div class="color-field w-[100px]" data-slot="color-field" data-channel="saturation"><label class="label" data-slot="label" for="_r_1_">Saturation</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_1_" inputmode="numeric" spellcheck="false" type="text" value="100%"><div class="color-input-group__suffix" data-slot="color-input-group-suffix"><span class="text-sm text-muted-foreground">%</span></div></div></div><style>
      [data-slot="color-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    </style><div class="color-field w-[100px]" data-slot="color-field" data-channel="lightness"><label class="label" data-slot="label" for="_r_2_">Lightness</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_2_" inputmode="numeric" spellcheck="false" type="text" value="25%"><div class="color-input-group__suffix" data-slot="color-input-group-suffix"><span class="text-sm text-muted-foreground">%</span></div></div></div></div><div class="flex items-center gap-2"><div aria-label="rgba(127, 0, 127, 1)" aria-roledescription="color swatch" class="color-swatch color-swatch--circle color-swatch--md" data-shape="circle" data-size="md" data-slot="color-swatch" role="img" style="--color-swatch-current: rgba(127, 0, 127, 1);"></div><span class="text-sm" data-source-initial-value="Current: #7F007F">Current: #7F007F</span></div></div></div></div>
```
