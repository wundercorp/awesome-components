...
- Source page: https://21st.dev/community/components/thanh/text-explode/default
- Registry URL: https://21st.dev/r/thanh/text-explode
- Author: thanh
- Component slug: text-explode
- Demo slug: default
- Title: text-explode
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/text-explode with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__text-explode__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__text-explode__default.png
