...
- Source page: https://21st.dev/community/components/ruixenui/radial-week-view/default
- Registry URL: https://21st.dev/r/ruixenui/radial-week-view
- Author: ruixenui
- Component slug: radial-week-view
- Demo slug: default
- Title: radial-week-view
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/radial-week-view with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__radial-week-view__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__radial-week-view__default.png
