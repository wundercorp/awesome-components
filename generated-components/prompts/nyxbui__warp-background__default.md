...
- Source page: https://21st.dev/community/components/nyxbui/warp-background/default
- Registry URL: https://21st.dev/r/nyxbui/warp-background
- Author: nyxbui
- Component slug: warp-background
- Demo slug: default
- Title: warp-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/nyxbui/warp-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/nyxbui__warp-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/nyxbui__warp-background__default.png
