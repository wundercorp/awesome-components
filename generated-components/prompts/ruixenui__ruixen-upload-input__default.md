...
- Source page: https://21st.dev/community/components/ruixenui/ruixen-upload-input/default
- Registry URL: https://21st.dev/r/ruixenui/ruixen-upload-input
- Author: ruixenui
- Component slug: ruixen-upload-input
- Demo slug: default
- Title: ruixen-upload-input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/ruixen-upload-input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__ruixen-upload-input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__ruixen-upload-input__default.png
