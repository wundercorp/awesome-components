...
- Source page: https://21st.dev/community/components/ruixenui/behavioral-history-select/default
- Registry URL: https://21st.dev/r/ruixenui/behavioral-history-select
- Author: ruixenui
- Component slug: behavioral-history-select
- Demo slug: default
- Title: behavioral-history-select
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/behavioral-history-select with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__behavioral-history-select__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__behavioral-history-select__default.png
