...
- Source page: https://21st.dev/community/components/kokonutd/hand-writing-text/default
- Registry URL: https://21st.dev/r/kokonutd/hand-writing-text
- Author: kokonutd
- Component slug: hand-writing-text
- Demo slug: default
- Title: hand-writing-text
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kokonutd/hand-writing-text with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kokonutd__hand-writing-text__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kokonutd__hand-writing-text__default.png
