...
- Source page: https://21st.dev/community/components/uniquesonu/animated-shifting-tab-component/default
- Registry URL: https://21st.dev/r/uniquesonu/animated-shifting-tab-component
- Author: uniquesonu
- Component slug: animated-shifting-tab-component
- Demo slug: default
- Title: animated-shifting-tab-component
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/animated-shifting-tab-component with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__animated-shifting-tab-component__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__animated-shifting-tab-component__default.png
