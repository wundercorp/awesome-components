...
- Source page: https://21st.dev/community/components/animata/flower-menu/default
- Registry URL: https://21st.dev/r/animata/flower-menu
- Author: animata
- Component slug: flower-menu
- Demo slug: default
- Title: flower-menu
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/animata/flower-menu with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/animata__flower-menu__default.html
- Local screenshot file: generated-21st-prompts/screenshots/animata__flower-menu__default.png
