...
- Source page: https://21st.dev/community/components/flower0wine/button-group/default
- Registry URL: https://21st.dev/r/flower0wine/button-group
- Author: flower0wine
- Component slug: button-group
- Demo slug: default
- Title: button-group
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/flower0wine/button-group with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/flower0wine__button-group__default.html
- Local screenshot file: generated-21st-prompts/screenshots/flower0wine__button-group__default.png
