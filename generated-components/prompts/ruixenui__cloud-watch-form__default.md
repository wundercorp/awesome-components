...
- Source page: https://21st.dev/community/components/ruixenui/cloud-watch-form/default
- Registry URL: https://21st.dev/r/ruixenui/cloud-watch-form
- Author: ruixenui
- Component slug: cloud-watch-form
- Demo slug: default
- Title: cloud-watch-form
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/cloud-watch-form with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__cloud-watch-form__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__cloud-watch-form__default.png
