...
- Source page: https://21st.dev/community/components/badtzx0/glowing-button/default
- Registry URL: https://21st.dev/r/badtzx0/glowing-button
- Author: badtzx0
- Component slug: glowing-button
- Demo slug: default
- Title: glowing-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/badtzx0/glowing-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/badtzx0__glowing-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/badtzx0__glowing-button__default.png
