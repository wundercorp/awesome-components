...
- Source page: https://21st.dev/community/components/muhammad-binsalman/flux-card-hero/default
- Registry URL: https://21st.dev/r/muhammad-binsalman/flux-card-hero
- Author: muhammad-binsalman
- Component slug: flux-card-hero
- Demo slug: default
- Title: flux-card-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/muhammad-binsalman/flux-card-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/muhammad-binsalman__flux-card-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/muhammad-binsalman__flux-card-hero__default.png
