...
- Source page: https://21st.dev/community/components/tommyjepsen/blog-section-with-rich-preview/default
- Registry URL: https://21st.dev/r/tommyjepsen/blog-section-with-rich-preview
- Author: tommyjepsen
- Component slug: blog-section-with-rich-preview
- Demo slug: default
- Title: blog-section-with-rich-preview
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tommyjepsen/blog-section-with-rich-preview with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tommyjepsen__blog-section-with-rich-preview__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tommyjepsen__blog-section-with-rich-preview__default.png
