...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-range-picker/form-example
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-range-picker
- Author: hero_ui
- Component slug: heroui-date-range-picker
- Demo slug: form-example
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-range-picker__form-example.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-range-picker__form-example.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><form class="form-demo"><style>
          .form-demo{display:flex;width:20rem;flex-direction:column;gap:12px;color:inherit}
        </style><div data-slot="date-range-picker" class="date-range-picker w-80" data-required="true"><style>
