...
- Source page: https://21st.dev/community/components/easemize/animated-svg-text-path/default
- Registry URL: https://21st.dev/r/easemize/animated-svg-text-path
- Author: easemize
- Component slug: animated-svg-text-path
- Demo slug: default
- Title: animated-svg-text-path
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/animated-svg-text-path with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__animated-svg-text-path__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__animated-svg-text-path__default.png
