...
- Source page: https://21st.dev/community/components/ui-layouts/sticky-scroll/default
- Registry URL: https://21st.dev/r/ui-layouts/sticky-scroll
- Author: ui-layouts
- Component slug: sticky-scroll
- Demo slug: default
- Title: sticky-scroll
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/sticky-scroll with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__sticky-scroll__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__sticky-scroll__default.png
