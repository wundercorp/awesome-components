...
- Source page: https://21st.dev/community/components/muhammad-binsalman/shiny-borders-button/default
- Registry URL: https://21st.dev/r/muhammad-binsalman/shiny-borders-button
- Author: muhammad-binsalman
- Component slug: shiny-borders-button
- Demo slug: default
- Title: shiny-borders-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/muhammad-binsalman/shiny-borders-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/muhammad-binsalman__shiny-borders-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/muhammad-binsalman__shiny-borders-button__default.png
