...
- Source page: https://21st.dev/community/components/reapollo/hero-ascii-one/default
- Registry URL: https://21st.dev/r/reapollo/hero-ascii-one
- Author: reapollo
- Component slug: hero-ascii-one
- Demo slug: default
- Title: hero-ascii-one
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reapollo/hero-ascii-one with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reapollo__hero-ascii-one__default.html
- Local screenshot file: generated-21st-prompts/screenshots/reapollo__hero-ascii-one__default.png
