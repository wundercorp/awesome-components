...
- Source page: https://21st.dev/community/components/ruixenui/futuristic-nav/default
- Registry URL: https://21st.dev/r/ruixenui/futuristic-nav
- Author: ruixenui
- Component slug: futuristic-nav
- Demo slug: default
- Title: futuristic-nav
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/futuristic-nav with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__futuristic-nav__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__futuristic-nav__default.png
