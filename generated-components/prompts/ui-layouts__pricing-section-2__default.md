...
- Source page: https://21st.dev/community/components/ui-layouts/pricing-section-2/default
- Registry URL: https://21st.dev/r/ui-layouts/pricing-section-2
- Author: ui-layouts
- Component slug: pricing-section-2
- Demo slug: default
- Title: pricing-section-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/pricing-section-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__pricing-section-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__pricing-section-2__default.png
