...
- Source page: https://21st.dev/community/components/aliimam/custom-cursor/default
- Registry URL: https://21st.dev/r/aliimam/custom-cursor
- Author: aliimam
- Component slug: custom-cursor
- Demo slug: default
- Title: custom-cursor
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/custom-cursor with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__custom-cursor__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__custom-cursor__default.png
