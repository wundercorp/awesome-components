...
- Source page: https://21st.dev/community/components/erikx/blog-post-card/default
- Registry URL: https://21st.dev/r/erikx/blog-post-card
- Author: erikx
- Component slug: blog-post-card
- Demo slug: default
- Title: blog-post-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/blog-post-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__blog-post-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__blog-post-card__default.png
