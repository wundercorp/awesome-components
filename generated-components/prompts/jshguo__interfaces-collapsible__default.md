...
- Source page: https://21st.dev/community/components/jshguo/interfaces-collapsible/default
- Registry URL: https://21st.dev/r/jshguo/interfaces-collapsible
- Author: jshguo
- Component slug: interfaces-collapsible
- Demo slug: default
- Title: interfaces-collapsible
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jshguo/interfaces-collapsible with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jshguo__interfaces-collapsible__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jshguo__interfaces-collapsible__default.png
