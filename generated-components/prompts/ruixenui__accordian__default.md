...
- Source page: https://21st.dev/community/components/ruixenui/accordian/default
- Registry URL: https://21st.dev/r/ruixenui/accordian
- Author: ruixenui
- Component slug: accordian
- Demo slug: default
- Title: accordian
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/accordian with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__accordian__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__accordian__default.png
