...
- Source page: https://21st.dev/community/components/tommyjepsen/feature-with-image-comparison/default
- Registry URL: https://21st.dev/r/tommyjepsen/feature-with-image-comparison
- Author: tommyjepsen
- Component slug: feature-with-image-comparison
- Demo slug: default
- Title: feature-with-image-comparison
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tommyjepsen/feature-with-image-comparison with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tommyjepsen__feature-with-image-comparison__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tommyjepsen__feature-with-image-comparison__default.png
