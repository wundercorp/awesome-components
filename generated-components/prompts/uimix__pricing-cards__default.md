...
- Source page: https://21st.dev/community/components/uimix/pricing-cards/default
- Registry URL: https://21st.dev/r/uimix/pricing-cards
- Author: uimix
- Component slug: pricing-cards
- Demo slug: default
- Title: pricing-cards
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uimix/pricing-cards with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uimix__pricing-cards__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uimix__pricing-cards__default.png
