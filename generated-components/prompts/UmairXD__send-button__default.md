...
- Source page: https://21st.dev/community/components/UmairXD/send-button/default
- Registry URL: https://21st.dev/r/UmairXD/send-button
- Author: UmairXD
- Component slug: send-button
- Demo slug: default
- Title: send-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/UmairXD/send-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/UmairXD__send-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/UmairXD__send-button__default.png
