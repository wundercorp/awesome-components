...
- Source page: https://21st.dev/community/components/shugar/choicebox-1/default
- Registry URL: https://21st.dev/r/shugar/choicebox-1
- Author: shugar
- Component slug: choicebox-1
- Demo slug: default
- Title: choicebox-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/choicebox-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__choicebox-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__choicebox-1__default.png
