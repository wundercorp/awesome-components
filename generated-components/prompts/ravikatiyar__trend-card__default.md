...
- Source page: https://21st.dev/community/components/ravikatiyar/trend-card/default
- Registry URL: https://21st.dev/r/ravikatiyar/trend-card
- Author: ravikatiyar
- Component slug: trend-card
- Demo slug: default
- Title: trend-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/trend-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__trend-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__trend-card__default.png
