...
- Source page: https://21st.dev/community/components/reui/accordion/default
- Registry URL: https://21st.dev/r/reui/accordion
- Author: reui
- Component slug: accordion
- Demo slug: default
- Title: accordion
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/reui/accordion with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/reui__accordion__default.html
- Local screenshot file: generated-21st-prompts/screenshots/reui__accordion__default.png
