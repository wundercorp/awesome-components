...
- Source page: https://21st.dev/community/components/theorcdev/8bit-breadcrumb/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-breadcrumb
- Author: theorcdev
- Component slug: 8bit-breadcrumb
- Demo slug: default
- Title: 8bit-breadcrumb
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-breadcrumb with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-breadcrumb__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-breadcrumb__default.png
