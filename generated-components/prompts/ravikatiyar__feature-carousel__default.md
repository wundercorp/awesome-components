...
- Source page: https://21st.dev/community/components/ravikatiyar/feature-carousel/default
- Registry URL: https://21st.dev/r/ravikatiyar/feature-carousel
- Author: ravikatiyar
- Component slug: feature-carousel
- Demo slug: default
- Title: feature-carousel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/feature-carousel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__feature-carousel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__feature-carousel__default.png
