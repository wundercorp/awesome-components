...
- Source page: https://21st.dev/community/components/intentui/card/default
- Registry URL: https://21st.dev/r/intentui/card
- Author: intentui
- Component slug: card
- Demo slug: default
- Title: card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/intentui/card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/intentui__card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/intentui__card__default.png
