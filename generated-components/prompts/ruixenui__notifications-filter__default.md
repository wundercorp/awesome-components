...
- Source page: https://21st.dev/community/components/ruixenui/notifications-filter/default
- Registry URL: https://21st.dev/r/ruixenui/notifications-filter
- Author: ruixenui
- Component slug: notifications-filter
- Demo slug: default
- Title: notifications-filter
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/notifications-filter with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__notifications-filter__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__notifications-filter__default.png
