...
- Source page: https://21st.dev/community/components/beratberkay/code-snippet/copy-button
- Registry URL: https://21st.dev/r/beratberkay/code-snippet
- Author: beratberkay
- Component slug: code-snippet
- Demo slug: copy-button
- Title: code-snippet
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/beratberkay/code-snippet with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/beratberkay__code-snippet__copy-button.html
- Local screenshot file: generated-21st-prompts/screenshots/beratberkay__code-snippet__copy-button.png
