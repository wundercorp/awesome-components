...
- Source page: https://21st.dev/community/components/ElevenLabs/voice-picker/default
- Registry URL: https://21st.dev/r/ElevenLabs/voice-picker
- Author: ElevenLabs
- Component slug: voice-picker
- Demo slug: default
- Title: voice-picker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ElevenLabs/voice-picker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ElevenLabs__voice-picker__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ElevenLabs__voice-picker__default.png
