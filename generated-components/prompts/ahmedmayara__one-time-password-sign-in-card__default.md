...
- Source page: https://21st.dev/community/components/ahmedmayara/one-time-password-sign-in-card/default
- Registry URL: https://21st.dev/r/ahmedmayara/one-time-password-sign-in-card
- Author: ahmedmayara
- Component slug: one-time-password-sign-in-card
- Demo slug: default
- Title: one-time-password-sign-in-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ahmedmayara/one-time-password-sign-in-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ahmedmayara__one-time-password-sign-in-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ahmedmayara__one-time-password-sign-in-card__default.png
