...
- Source page: https://21st.dev/community/components/uniquesonu/modern-hero-section/default
- Registry URL: https://21st.dev/r/uniquesonu/modern-hero-section
- Author: uniquesonu
- Component slug: modern-hero-section
- Demo slug: default
- Title: modern-hero-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/modern-hero-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__modern-hero-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__modern-hero-section__default.png
