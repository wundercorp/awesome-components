...
- Source page: https://21st.dev/community/components/edwinvakayil/one-accordion/default
- Registry URL: https://21st.dev/r/edwinvakayil/one-accordion
- Author: edwinvakayil
- Component slug: one-accordion
- Demo slug: default
- Title: one-accordion
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/one-accordion with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__one-accordion__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__one-accordion__default.png
