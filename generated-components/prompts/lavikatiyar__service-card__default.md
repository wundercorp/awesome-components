...
- Source page: https://21st.dev/community/components/lavikatiyar/service-card/default
- Registry URL: https://21st.dev/r/lavikatiyar/service-card
- Author: lavikatiyar
- Component slug: service-card
- Demo slug: default
- Title: service-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/service-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__service-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__service-card__default.png
