...
- Source page: https://21st.dev/community/components/erikx/3d-hero-section-boxes/default
- Registry URL: https://21st.dev/r/erikx/3d-hero-section-boxes
- Author: erikx
- Component slug: 3d-hero-section-boxes
- Demo slug: default
- Title: 3d-hero-section-boxes
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/3d-hero-section-boxes with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__3d-hero-section-boxes__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__3d-hero-section-boxes__default.png
