...
- Source page: https://21st.dev/community/components/theorcdev/8bit-toggle-group/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-toggle-group
- Author: theorcdev
- Component slug: 8bit-toggle-group
- Demo slug: default
- Title: 8bit-toggle-group
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-toggle-group with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-toggle-group__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-toggle-group__default.png
