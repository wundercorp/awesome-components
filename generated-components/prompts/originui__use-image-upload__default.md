...
- Source page: https://21st.dev/community/components/originui/use-image-upload/default
- Registry URL: https://21st.dev/r/originui/use-image-upload
- Author: originui
- Component slug: use-image-upload
- Demo slug: default
- Title: use-image-upload
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/originui/use-image-upload with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/originui__use-image-upload__default.html
- Local screenshot file: generated-21st-prompts/screenshots/originui__use-image-upload__default.png
