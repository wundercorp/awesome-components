...
- Source page: https://21st.dev/community/components/chow-stack/globe-hero/default
- Registry URL: https://21st.dev/r/chow-stack/globe-hero
- Author: chow-stack
- Component slug: globe-hero
- Demo slug: default
- Title: globe-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/chow-stack/globe-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/chow-stack__globe-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/chow-stack__globe-hero__default.png
