...
- Source page: https://21st.dev/community/components/UmairXD/siri-orb/default
- Registry URL: https://21st.dev/r/UmairXD/siri-orb
- Author: UmairXD
- Component slug: siri-orb
- Demo slug: default
- Title: siri-orb
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/UmairXD/siri-orb with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/UmairXD__siri-orb__default.html
- Local screenshot file: generated-21st-prompts/screenshots/UmairXD__siri-orb__default.png
