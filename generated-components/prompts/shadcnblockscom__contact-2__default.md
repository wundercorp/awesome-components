...
- Source page: https://21st.dev/community/components/shadcnblockscom/contact-2/default
- Registry URL: https://21st.dev/r/shadcnblockscom/contact-2
- Author: shadcnblockscom
- Component slug: contact-2
- Demo slug: default
- Title: contact-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcnblockscom/contact-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcnblockscom__contact-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcnblockscom__contact-2__default.png
