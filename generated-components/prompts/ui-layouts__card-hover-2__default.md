...
- Source page: https://21st.dev/community/components/ui-layouts/card-hover-2/default
- Registry URL: https://21st.dev/r/ui-layouts/card-hover-2
- Author: ui-layouts
- Component slug: card-hover-2
- Demo slug: default
- Title: card-hover-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/card-hover-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__card-hover-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__card-hover-2__default.png
