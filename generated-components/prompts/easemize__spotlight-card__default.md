...
- Source page: https://21st.dev/community/components/easemize/spotlight-card/default
- Registry URL: https://21st.dev/r/easemize/spotlight-card
- Author: easemize
- Component slug: spotlight-card
- Demo slug: default
- Title: spotlight-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/spotlight-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__spotlight-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__spotlight-card__default.png
