...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/required-field
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__required-field.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__required-field.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field" data-required="true"><label class="label" data-required="true" data-slot="label" for="_r_1_">Theme Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_1_" inputmode="text" placeholder="#000000" spellcheck="false" type="text" value="" name="theme-color"></div><span class="description" data-slot="description">Required field</span></div></div></div></div>
```
