...
- Source page: https://21st.dev/community/components/magicui/smooth-cursor/default
- Registry URL: https://21st.dev/r/magicui/smooth-cursor
- Author: magicui
- Component slug: smooth-cursor
- Demo slug: default
- Title: smooth-cursor
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/magicui/smooth-cursor with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/magicui__smooth-cursor__default.html
- Local screenshot file: generated-21st-prompts/screenshots/magicui__smooth-cursor__default.png
