...
- Source page: https://21st.dev/community/components/hero_ui/heroui-color-field/with-description
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-color-field__with-description.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-color-field__with-description.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="color-field w-[280px]" data-slot="color-field"><label class="label" data-slot="label" for="_r_1_">Accent Color</label><div role="presentation" class="color-input-group color-input-group--primary" data-slot="color-input-group" data-variant="primary"><input autocomplete="off" autocorrect="off" class="color-input-group__input" data-slot="color-input-group-input" id="_r_1_" inputmode="text" spellcheck="false" type="text" value="#F59E0B" name="accent-color"></div><span class="description" data-slot="description">Used for highlights and CTAs</span></div></div></div></div>
```
