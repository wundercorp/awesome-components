...
- Source page: https://21st.dev/community/components/shugar/split-button/menu-alignment
- Registry URL: https://21st.dev/r/shugar/split-button
- Author: shugar
- Component slug: split-button
- Demo slug: menu-alignment
- Title: split-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shugar/split-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shugar__split-button__menu-alignment.html
- Local screenshot file: generated-21st-prompts/screenshots/shugar__split-button__menu-alignment.png
