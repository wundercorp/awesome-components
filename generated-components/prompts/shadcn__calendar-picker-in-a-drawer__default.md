...
- Source page: https://21st.dev/community/components/shadcn/calendar-picker-in-a-drawer/default
- Registry URL: https://21st.dev/r/shadcn/calendar-picker-in-a-drawer
- Author: shadcn
- Component slug: calendar-picker-in-a-drawer
- Demo slug: default
- Title: calendar-picker-in-a-drawer
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/calendar-picker-in-a-drawer with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__calendar-picker-in-a-drawer__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__calendar-picker-in-a-drawer__default.png
