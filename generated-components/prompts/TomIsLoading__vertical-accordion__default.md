...
- Source page: https://21st.dev/community/components/TomIsLoading/vertical-accordion/default
- Registry URL: https://21st.dev/r/TomIsLoading/vertical-accordion
- Author: TomIsLoading
- Component slug: vertical-accordion
- Demo slug: default
- Title: vertical-accordion
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/TomIsLoading/vertical-accordion with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/TomIsLoading__vertical-accordion__default.html
- Local screenshot file: generated-21st-prompts/screenshots/TomIsLoading__vertical-accordion__default.png
