...
- Source page: https://21st.dev/community/components/ruixenui/split-action-button/default
- Registry URL: https://21st.dev/r/ruixenui/split-action-button
- Author: ruixenui
- Component slug: split-action-button
- Demo slug: default
- Title: split-action-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/split-action-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__split-action-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__split-action-button__default.png
