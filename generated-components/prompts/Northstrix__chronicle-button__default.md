...
- Source page: https://21st.dev/community/components/Northstrix/chronicle-button/default
- Registry URL: https://21st.dev/r/Northstrix/chronicle-button
- Author: Northstrix
- Component slug: chronicle-button
- Demo slug: default
- Title: chronicle-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Northstrix/chronicle-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Northstrix__chronicle-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Northstrix__chronicle-button__default.png
