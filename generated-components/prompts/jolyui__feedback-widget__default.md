...
- Source page: https://21st.dev/community/components/jolyui/feedback-widget/default
- Registry URL: https://21st.dev/r/jolyui/feedback-widget
- Author: jolyui
- Component slug: feedback-widget
- Demo slug: default
- Title: feedback-widget
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jolyui/feedback-widget with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jolyui__feedback-widget__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jolyui__feedback-widget__default.png
