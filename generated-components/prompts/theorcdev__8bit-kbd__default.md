...
- Source page: https://21st.dev/community/components/theorcdev/8bit-kbd/default
- Registry URL: https://21st.dev/r/theorcdev/8bit-kbd
- Author: theorcdev
- Component slug: 8bit-kbd
- Demo slug: default
- Title: 8bit-kbd
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/theorcdev/8bit-kbd with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/theorcdev__8bit-kbd__default.html
- Local screenshot file: generated-21st-prompts/screenshots/theorcdev__8bit-kbd__default.png
