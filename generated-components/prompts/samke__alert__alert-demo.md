...
- Source page: https://21st.dev/community/components/samke/alert/alert-demo
- Registry URL: https://21st.dev/r/samke/alert
- Author: samke
- Component slug: alert
- Demo slug: alert-demo
- Title: alert
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/samke/alert with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/samke__alert__alert-demo.html
- Local screenshot file: generated-21st-prompts/screenshots/samke__alert__alert-demo.png
