...
- Source page: https://21st.dev/community/components/danielpetho/use-mouse-vector/default
- Registry URL: https://21st.dev/r/danielpetho/use-mouse-vector
- Author: danielpetho
- Component slug: use-mouse-vector
- Demo slug: default
- Title: use-mouse-vector
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/use-mouse-vector with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__use-mouse-vector__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__use-mouse-vector__default.png
