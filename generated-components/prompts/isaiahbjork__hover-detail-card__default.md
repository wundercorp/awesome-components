...
- Source page: https://21st.dev/community/components/isaiahbjork/hover-detail-card/default
- Registry URL: https://21st.dev/r/isaiahbjork/hover-detail-card
- Author: isaiahbjork
- Component slug: hover-detail-card
- Demo slug: default
- Title: hover-detail-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/isaiahbjork/hover-detail-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/isaiahbjork__hover-detail-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/isaiahbjork__hover-detail-card__default.png
