...
- Source page: https://21st.dev/community/components/ravikatiyar/product-card-2/default
- Registry URL: https://21st.dev/r/ravikatiyar/product-card-2
- Author: ravikatiyar
- Component slug: product-card-2
- Demo slug: default
- Title: product-card-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/product-card-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__product-card-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__product-card-2__default.png
