...
- Source page: https://21st.dev/community/components/ringlabs/animated-check-box/default
- Registry URL: https://21st.dev/r/ringlabs/animated-check-box
- Author: ringlabs
- Component slug: animated-check-box
- Demo slug: default
- Title: animated-check-box
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ringlabs/animated-check-box with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ringlabs__animated-check-box__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ringlabs__animated-check-box__default.png
