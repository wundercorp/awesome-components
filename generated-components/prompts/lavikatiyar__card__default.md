...
- Source page: https://21st.dev/community/components/lavikatiyar/card/default
- Registry URL: https://21st.dev/r/lavikatiyar/card
- Author: lavikatiyar
- Component slug: card
- Demo slug: default
- Title: card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__card__default.png
