...
- Source page: https://21st.dev/community/components/devetaigabbai/depth-button/default
- Registry URL: https://21st.dev/r/devetaigabbai/depth-button
- Author: devetaigabbai
- Component slug: depth-button
- Demo slug: default
- Title: depth-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/devetaigabbai/depth-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/devetaigabbai__depth-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/devetaigabbai__depth-button__default.png
