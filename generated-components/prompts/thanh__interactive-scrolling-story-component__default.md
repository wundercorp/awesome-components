...
- Source page: https://21st.dev/community/components/thanh/interactive-scrolling-story-component/default
- Registry URL: https://21st.dev/r/thanh/interactive-scrolling-story-component
- Author: thanh
- Component slug: interactive-scrolling-story-component
- Demo slug: default
- Title: interactive-scrolling-story-component
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/interactive-scrolling-story-component with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__interactive-scrolling-story-component__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__interactive-scrolling-story-component__default.png
