...
- Source page: https://21st.dev/community/components/erikx/navbar-with-animated-mega-dropdown/default
- Registry URL: https://21st.dev/r/erikx/navbar-with-animated-mega-dropdown
- Author: erikx
- Component slug: navbar-with-animated-mega-dropdown
- Demo slug: default
- Title: navbar-with-animated-mega-dropdown
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/erikx/navbar-with-animated-mega-dropdown with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/erikx__navbar-with-animated-mega-dropdown__default.html
- Local screenshot file: generated-21st-prompts/screenshots/erikx__navbar-with-animated-mega-dropdown__default.png
