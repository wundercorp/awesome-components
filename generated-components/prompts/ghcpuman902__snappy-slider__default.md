...
- Source page: https://21st.dev/community/components/ghcpuman902/snappy-slider/default
- Registry URL: https://21st.dev/r/ghcpuman902/snappy-slider
- Author: ghcpuman902
- Component slug: snappy-slider
- Demo slug: default
- Title: snappy-slider
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ghcpuman902/snappy-slider with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ghcpuman902__snappy-slider__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ghcpuman902__snappy-slider__default.png
