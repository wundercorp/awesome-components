...
- Source page: https://21st.dev/community/components/kavikatiyar/card-7/default
- Registry URL: https://21st.dev/r/kavikatiyar/card-7
- Author: kavikatiyar
- Component slug: card-7
- Demo slug: default
- Title: card-7
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kavikatiyar/card-7 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kavikatiyar__card-7__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kavikatiyar__card-7__default.png
