...
- Source page: https://21st.dev/community/components/intentui/loader/default
- Registry URL: https://21st.dev/r/intentui/loader
- Author: intentui
- Component slug: loader
- Demo slug: default
- Title: loader
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/intentui/loader with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/intentui__loader__default.html
- Local screenshot file: generated-21st-prompts/screenshots/intentui__loader__default.png
