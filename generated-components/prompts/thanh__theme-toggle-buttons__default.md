...
- Source page: https://21st.dev/community/components/thanh/theme-toggle-buttons/default
- Registry URL: https://21st.dev/r/thanh/theme-toggle-buttons
- Author: thanh
- Component slug: theme-toggle-buttons
- Demo slug: default
- Title: theme-toggle-buttons
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/theme-toggle-buttons with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__theme-toggle-buttons__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__theme-toggle-buttons__default.png
