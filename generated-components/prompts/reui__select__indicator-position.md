...
- Source page: https://21st.dev/community/components/reui/select/indicator-position
- Registry URL: https://21st.dev/r/reui/select
- Author: reui
- Component slug: select
- Demo slug: indicator-position
- Title: select
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/reui__select__indicator-position.html
- Local screenshot file: generated-21st-prompts/screenshots/reui__select__indicator-position.png
