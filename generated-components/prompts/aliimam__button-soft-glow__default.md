...
- Source page: https://21st.dev/community/components/aliimam/button-soft-glow/default
- Registry URL: https://21st.dev/r/aliimam/button-soft-glow
- Author: aliimam
- Component slug: button-soft-glow
- Demo slug: default
- Title: button-soft-glow
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/button-soft-glow with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__button-soft-glow__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__button-soft-glow__default.png
