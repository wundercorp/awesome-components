...
- Source page: https://21st.dev/community/components/muhammad-binsalman/yield-card/default
- Registry URL: https://21st.dev/r/muhammad-binsalman/yield-card
- Author: muhammad-binsalman
- Component slug: yield-card
- Demo slug: default
- Title: yield-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/muhammad-binsalman/yield-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/muhammad-binsalman__yield-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/muhammad-binsalman__yield-card__default.png
