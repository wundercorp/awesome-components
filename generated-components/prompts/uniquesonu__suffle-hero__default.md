...
- Source page: https://21st.dev/community/components/uniquesonu/suffle-hero/default
- Registry URL: https://21st.dev/r/uniquesonu/suffle-hero
- Author: uniquesonu
- Component slug: suffle-hero
- Demo slug: default
- Title: suffle-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/suffle-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__suffle-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__suffle-hero__default.png
