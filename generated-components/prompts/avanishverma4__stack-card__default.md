...
- Source page: https://21st.dev/community/components/avanishverma4/stack-card/default
- Registry URL: https://21st.dev/r/avanishverma4/stack-card
- Author: avanishverma4
- Component slug: stack-card
- Demo slug: default
- Title: stack-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/avanishverma4/stack-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/avanishverma4__stack-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/avanishverma4__stack-card__default.png
