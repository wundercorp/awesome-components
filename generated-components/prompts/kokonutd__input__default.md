...
- Source page: https://21st.dev/community/components/kokonutd/input/default
- Registry URL: https://21st.dev/r/kokonutd/input
- Author: kokonutd
- Component slug: input
- Demo slug: default
- Title: input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/kokonutd/input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/kokonutd__input__default.html
- Local screenshot file: generated-21st-prompts/screenshots/kokonutd__input__default.png
