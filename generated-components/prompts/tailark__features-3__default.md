...
- Source page: https://21st.dev/community/components/tailark/features-3/default
- Registry URL: https://21st.dev/r/tailark/features-3
- Author: tailark
- Component slug: features-3
- Demo slug: default
- Title: features-3
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/tailark/features-3 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/tailark__features-3__default.html
- Local screenshot file: generated-21st-prompts/screenshots/tailark__features-3__default.png
