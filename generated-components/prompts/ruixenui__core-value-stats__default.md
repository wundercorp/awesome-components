...
- Source page: https://21st.dev/community/components/ruixenui/core-value-stats/default
- Registry URL: https://21st.dev/r/ruixenui/core-value-stats
- Author: ruixenui
- Component slug: core-value-stats
- Demo slug: default
- Title: core-value-stats
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/core-value-stats with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__core-value-stats__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__core-value-stats__default.png
