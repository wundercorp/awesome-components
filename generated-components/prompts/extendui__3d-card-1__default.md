...
- Source page: https://21st.dev/community/components/extendui/3d-card-1/default
- Registry URL: https://21st.dev/r/extendui/3d-card-1
- Author: extendui
- Component slug: 3d-card-1
- Demo slug: default
- Title: 3d-card-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/extendui/3d-card-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/extendui__3d-card-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/extendui__3d-card-1__default.png
