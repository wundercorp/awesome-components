...
- Source page: https://21st.dev/community/components/ravikatiyar/orbiting-avatars/default
- Registry URL: https://21st.dev/r/ravikatiyar/orbiting-avatars
- Author: ravikatiyar
- Component slug: orbiting-avatars
- Demo slug: default
- Title: orbiting-avatars
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ravikatiyar/orbiting-avatars with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ravikatiyar__orbiting-avatars__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ravikatiyar__orbiting-avatars__default.png
