...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-range-picker/international-calendar
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-range-picker__international-calendar.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-range-picker__international-calendar.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div data-slot="date-range-picker" class="date-range-picker w-80"><style>
    ...
    </style><span class="label" data-slot="label">Trip dates</span><div class="date-input-group" data-slot="date-input-group" role="group"><div class="date-input-group__input" data-slot="date-input-group-input"><span data-slot="date-range-start-input" class="date-range-picker__input"><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="month, " tabindex="0">12</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="day, " tabindex="0">3</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="year, " tabindex="0">1948</span><span class="date-input-group__literal">&nbsp;शक</span></span><span data-slot="date-range-picker-range-separator" class="date-range-picker__separator"> - </span><span data-slot="date-range-end-input" class="date-range-picker__input"><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="month, " tabindex="0">19</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="day, " tabindex="0">3</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="year, " tabindex="0">1948</span><span class="date-input-group__literal">&nbsp;शक</span></span></div><input hidden="" readonly="" value="1948-03-12" name="start"><input hidden="" readonly="" value="1948-03-19" name="end"><div class="date-input-group__suffix" data-slot="date-input-group-suffix"><button aria-expanded="false" aria-haspopup="dialog" aria-label="Calendar" class="date-range-picker__trigger" data-slot="date-range-picker-trigger" type="button"><span aria-hidden="true" class="date-range-picker__trigger-indicator" data-slot="date-range-picker-trigger-indicator"><svg aria-hidden="true" fill="none" height="1em" role="presentation" viewBox="0 0 13 14" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M3.75 4.5A.75.75 0 0 1 3 3.75v-.748a1.5 1.5 0 0 0-1.5 1.5v1h10v-1a1.5 1.5 0 0 0-1.5-1.5v.75a.75.75 0 1 1-1.5 0v-.75h-4v.747a.75.75 0 0 1-.75.75ZM8.5 1.501h-4V.75a.75.75 0 0 0-1.5 0v.752a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h7a3 3 0 0 0 3-3v-6a3 3 0 0 0-3-3v-.75a.75.75 0 0 0-1.5 0v.75Zm-7 5.5v3.5a1.5 1.5 0 0 0 1.5 1.5h7a1.5 1.5 0 0 0 1.5-1.5v-3.5h-10Z" fill="currentColor" fill-rule="evenodd"></path></svg></span></button></div></div></div></div></div>
```
