...
- Source page: https://21st.dev/community/components/originui/input/input-with-start-add-on
- Registry URL: https://21st.dev/r/originui/input
- Author: originui
- Component slug: input
- Demo slug: input-with-start-add-on
- Title: input
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/originui__input__input-with-start-add-on.html
- Local screenshot file: generated-21st-prompts/screenshots/originui__input__input-with-start-add-on.png
