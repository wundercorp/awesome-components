...
- Source page: https://21st.dev/community/components/thanh/dynamic-animated-hero-section-with-gradient/default
- Registry URL: https://21st.dev/r/thanh/dynamic-animated-hero-section-with-gradient
- Author: thanh
- Component slug: dynamic-animated-hero-section-with-gradient
- Demo slug: default
- Title: dynamic-animated-hero-section-with-gradient
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/dynamic-animated-hero-section-with-gradient with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__dynamic-animated-hero-section-with-gradient__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__dynamic-animated-hero-section-with-gradient__default.png
