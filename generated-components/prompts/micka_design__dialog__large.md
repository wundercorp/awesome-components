...
- Source page: https://21st.dev/community/components/micka_design/dialog/large
- Registry URL: https://21st.dev/r/micka_design/dialog
- Author: micka_design
- Component slug: dialog
- Demo slug: large
- Title: dialog
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/micka_design/dialog with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/micka_design__dialog__large.html
- Local screenshot file: generated-21st-prompts/screenshots/micka_design__dialog__large.png
