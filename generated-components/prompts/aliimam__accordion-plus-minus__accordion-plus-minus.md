...
- Source page: https://21st.dev/community/components/aliimam/accordion-plus-minus/accordion-plus-minus
- Registry URL: https://21st.dev/r/aliimam/accordion-plus-minus
- Author: aliimam
- Component slug: accordion-plus-minus
- Demo slug: accordion-plus-minus
- Title: accordion-plus-minus
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aliimam/accordion-plus-minus with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aliimam__accordion-plus-minus__accordion-plus-minus.html
- Local screenshot file: generated-21st-prompts/screenshots/aliimam__accordion-plus-minus__accordion-plus-minus.png
