...
- Source page: https://21st.dev/community/components/shadcnspace/apple-dock/default
- Registry URL: https://21st.dev/r/shadcnspace/apple-dock
- Author: shadcnspace
- Component slug: apple-dock
- Demo slug: default
- Title: apple-dock
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcnspace/apple-dock with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcnspace__apple-dock__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcnspace__apple-dock__default.png
