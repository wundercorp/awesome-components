...
- Source page: https://21st.dev/community/components/ruixenui/universal-date-picker/default
- Registry URL: https://21st.dev/r/ruixenui/universal-date-picker
- Author: ruixenui
- Component slug: universal-date-picker
- Demo slug: default
- Title: universal-date-picker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/universal-date-picker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__universal-date-picker__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__universal-date-picker__default.png
