...
- Source page: https://21st.dev/community/components/ruixenui/ruixen-featured-image-section/default
- Registry URL: https://21st.dev/r/ruixenui/ruixen-featured-image-section
- Author: ruixenui
- Component slug: ruixen-featured-image-section
- Demo slug: default
- Title: ruixen-featured-image-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/ruixen-featured-image-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__ruixen-featured-image-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__ruixen-featured-image-section__default.png
