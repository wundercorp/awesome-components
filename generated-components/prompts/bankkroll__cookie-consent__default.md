...
- Source page: https://21st.dev/community/components/bankkroll/cookie-consent/default
- Registry URL: https://21st.dev/r/bankkroll/cookie-consent
- Author: bankkroll
- Component slug: cookie-consent
- Demo slug: default
- Title: cookie-consent
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/bankkroll/cookie-consent with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/bankkroll__cookie-consent__default.html
- Local screenshot file: generated-21st-prompts/screenshots/bankkroll__cookie-consent__default.png
