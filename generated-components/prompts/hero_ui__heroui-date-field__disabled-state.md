...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-field/disabled-state
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-field
- Author: hero_ui
- Component slug: heroui-date-field
- Demo slug: disabled-state
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-field__disabled-state.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-field__disabled-state.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div class="flex flex-col gap-4"><style>
    ...
    </style><div class="date-field w-[256px]" data-disabled="true" data-slot="date-field" role="group"><label data-slot="label">Date</label><div class="date-input-group date-input-group--primary" data-disabled="true" data-slot="date-input-group" data-variant="primary"><div aria-label="date" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-disabled="true" aria-label="month" aria-valuetext="6" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="month" role="spinbutton">6</span><span aria-disabled="true" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-disabled="true" aria-label="day" aria-valuetext="27" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="day" role="spinbutton">27</span><span aria-disabled="true" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-disabled="true" aria-label="year" aria-valuetext="2026" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="year" role="spinbutton">2026</span><input readonly="" type="hidden" value="2026-06-27" name="date"></div></div><span data-slot="description">This date field is disabled</span></div><style>
      [data-slot="date-field"] {
        display: flex;
        flex-direction: column;
        gap: 4px;
      ...
      .light [data-slot="select-popover"],
      .light [data-slot="tooltip-content"] { background: hsl(var(--surface, 0 0% 100%)); color: hsl(var(--foreground, 240 10% 4%)); border-color: hsl(var(--border, 240 6% 90%)); box-shadow: 0 10px 30px rgb(0 0 0 / .08); }
    </style><div class="date-field w-[256px]" data-disabled="true" data-slot="date-field" role="group"><label data-slot="label">Date</label><div class="date-input-group date-input-group--primary" data-disabled="true" data-slot="date-input-group" data-variant="primary"><div aria-label="date-empty" class="date-input-group__input" data-slot="date-input-group-input" role="presentation"><span aria-disabled="true" aria-label="month" aria-valuetext="mm" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="month" role="spinbutton">mm</span><span aria-disabled="true" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-disabled="true" aria-label="day" aria-valuetext="dd" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="day" role="spinbutton">dd</span><span aria-disabled="true" class="date-input-group__segment" data-slot="date-input-group-segment" data-type="literal">/</span><span aria-disabled="true" aria-label="year" aria-valuetext="yyyy" class="date-input-group__segment" data-placeholder="true" data-slot="date-input-group-segment" data-type="year" role="spinbutton">yyyy</span><input readonly="" type="hidden" value="" name="date-empty"></div></div><span data-slot="description">This date field is disabled</span></div></div></div></div>
```
