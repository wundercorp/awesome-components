...
- Source page: https://21st.dev/community/components/danielpetho/use-mouse-position/default
- Registry URL: https://21st.dev/r/danielpetho/use-mouse-position
- Author: danielpetho
- Component slug: use-mouse-position
- Demo slug: default
- Title: use-mouse-position
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/danielpetho/use-mouse-position with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/danielpetho__use-mouse-position__default.html
- Local screenshot file: generated-21st-prompts/screenshots/danielpetho__use-mouse-position__default.png
