...
- Source page: https://21st.dev/community/components/shadcn/input/grouped-with-button
- Registry URL: https://21st.dev/r/shadcn/input
- Author: shadcn
- Component slug: input
- Demo slug: grouped-with-button
- Title: input
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shadcn/input with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shadcn__input__grouped-with-button.html
- Local screenshot file: generated-21st-prompts/screenshots/shadcn__input__grouped-with-button.png
