...
- Source page: https://21st.dev/community/components/hammamikhairi/animated-gradient-background/default
- Registry URL: https://21st.dev/r/hammamikhairi/animated-gradient-background
- Author: hammamikhairi
- Component slug: animated-gradient-background
- Demo slug: default
- Title: animated-gradient-background
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hammamikhairi/animated-gradient-background with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hammamikhairi__animated-gradient-background__default.html
- Local screenshot file: generated-21st-prompts/screenshots/hammamikhairi__animated-gradient-background__default.png
