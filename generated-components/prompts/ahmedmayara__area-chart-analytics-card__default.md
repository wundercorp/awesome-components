...
- Source page: https://21st.dev/community/components/ahmedmayara/area-chart-analytics-card/default
- Registry URL: https://21st.dev/r/ahmedmayara/area-chart-analytics-card
- Author: ahmedmayara
- Component slug: area-chart-analytics-card
- Demo slug: default
- Title: area-chart-analytics-card
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ahmedmayara/area-chart-analytics-card with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ahmedmayara__area-chart-analytics-card__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ahmedmayara__area-chart-analytics-card__default.png
