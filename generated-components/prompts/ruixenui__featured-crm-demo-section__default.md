...
- Source page: https://21st.dev/community/components/ruixenui/featured-crm-demo-section/default
- Registry URL: https://21st.dev/r/ruixenui/featured-crm-demo-section
- Author: ruixenui
- Component slug: featured-crm-demo-section
- Demo slug: default
- Title: featured-crm-demo-section
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/featured-crm-demo-section with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__featured-crm-demo-section__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__featured-crm-demo-section__default.png
