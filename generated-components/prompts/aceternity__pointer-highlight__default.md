...
- Source page: https://21st.dev/community/components/aceternity/pointer-highlight/default
- Registry URL: https://21st.dev/r/aceternity/pointer-highlight
- Author: aceternity
- Component slug: pointer-highlight
- Demo slug: default
- Title: pointer-highlight
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/aceternity/pointer-highlight with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/aceternity__pointer-highlight__default.html
- Local screenshot file: generated-21st-prompts/screenshots/aceternity__pointer-highlight__default.png
