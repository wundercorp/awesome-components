...
- Source page: https://21st.dev/community/components/easemize/dynamic-hero/default
- Registry URL: https://21st.dev/r/easemize/dynamic-hero
- Author: easemize
- Component slug: dynamic-hero
- Demo slug: default
- Title: dynamic-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/easemize/dynamic-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/easemize__dynamic-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/easemize__dynamic-hero__default.png
