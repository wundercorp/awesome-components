...
- Source page: https://21st.dev/community/components/coss.com/progress/default
- Registry URL: https://21st.dev/r/coss.com/progress
- Author: coss.com
- Component slug: progress
- Demo slug: default
- Title: progress
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/coss.com/progress with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/coss.com__progress__default.html
- Local screenshot file: generated-21st-prompts/screenshots/coss.com__progress__default.png
