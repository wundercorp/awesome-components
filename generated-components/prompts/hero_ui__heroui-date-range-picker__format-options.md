...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-range-picker/format-options
- Registry URL: https://21st.dev/r/hero_ui/heroui-date-range-picker
- Author: hero_ui
- Component slug: heroui-date-range-picker
- Demo slug: format-options
- Title: heroui-date-range-picker
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/hero_ui/heroui-date-range-picker with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-range-picker__format-options.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-range-picker__format-options.png
...
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><style>
      ...
      </style><div class="format-options-demo"><div data-slot="date-range-picker" class="date-range-picker min-w-96"><style>
    ...
    </style><span class="label" data-slot="label">Date range</span><div class="date-input-group" data-slot="date-input-group" role="group"><div class="date-input-group__input" data-slot="date-input-group-input"><span data-slot="date-range-start-input" class="date-range-picker__input"><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="month, " tabindex="0">2</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="day, " tabindex="0">3</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="year, " tabindex="0">2026</span><span class="date-input-group__literal">,&nbsp;</span><span class="date-input-group__literal">⁦</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="hour, " tabindex="0">8</span><span class="date-input-group__literal">:</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="minute, " tabindex="0">45</span><span class="date-input-group__literal">⁩ AM GMT+4</span></span><span data-slot="date-range-picker-range-separator" class="date-range-picker__separator"> - </span><span data-slot="date-range-end-input" class="date-range-picker__input"><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="month, " tabindex="0">2</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="day, " tabindex="0">10</span><span class="date-input-group__literal">/</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="year, " tabindex="0">2026</span><span class="date-input-group__literal">,&nbsp;</span><span class="date-input-group__literal">⁦</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="hour, " tabindex="0">18</span><span class="date-input-group__literal">:</span><span data-slot="date-input-group-segment" class="date-input-group__segment" role="spinbutton" aria-label="minute, " tabindex="0">45</span><span class="date-input-group__literal">⁩ PM GMT+4</span></span></div><input hidden="" readonly="" value="2026-02-03" name="start"><input hidden="" readonly="" value="2026-02-10" name="end"><div class="date-input-group__suffix" data-slot="date-input-group-suffix"><button aria-expanded="false" aria-haspopup="dialog" aria-label="Calendar" class="date-range-picker__trigger" data-slot="date-range-picker-trigger" type="button"><span aria-hidden="true" class="date-range-picker__trigger-indicator" data-slot="date-range-picker-trigger-indicator"><svg aria-hidden="true" fill="none" height="1em" role="presentation" viewBox="0 0 13 14" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M3.75 4.5A.75.75 0 0 1 3 3.75v-.748a1.5 1.5 0 0 0-1.5 1.5v1h10v-1a1.5 1.5 0 0 0-1.5-1.5v.75a.75.75 0 1 1-1.5 0v-.75h-4v.747a.75.75 0 0 1-.75.75ZM8.5 1.501h-4V.75a.75.75 0 0 0-1.5 0v.752a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h7a3 3 0 0 0 3-3v-6a3 3 0 0 0-3-3v-.75a.75.75 0 0 0-1.5 0v.75Zm-7 5.5v3.5a1.5 1.5 0 0 0 1.5 1.5h7a1.5 1.5 0 0 0 1.5-1.5v-3.5h-10Z" fill="currentColor" fill-rule="evenodd"></path></svg></span></button></div></div></div><span class="format-options-title">Format Options</span><div class="format-options-controls"><label class="format-options-field"><span>Granularity</span><span class="format-options-select">Minute<svg viewBox="0 0 16 16" aria-hidden="true"><path fill="currentColor" d="M2.97 5.47a.75.75 0 0 1 1.06 0L8 9.44l3.97-3.97a.75.75 0 1 1 1.06 1.06l-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5a.75.75 0 0 1 0-1.06"></path></svg></span><span class="format-options-menu"><span>Day</span><span>Hour</span><span>Minute</span><span>Second</span></span></label><label class="format-options-field"><span>Hour cycle</span><span class="format-options-select">12-hour<svg viewBox="0 0 16 16" aria-hidden="true"><path fill="currentColor" d="M2.97 5.47a.75.75 0 0 1 1.06 0L8 9.44l3.97-3.97a.75.75 0 1 1 1.06 1.06l-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5a.75.75 0 0 1 0-1.06"></path></svg></span><span class="format-options-menu"><span>12-hour</span><span>24-hour</span></span></label></div><div class="format-options-switches"><label class="format-options-switch-row"><span class="format-options-switch" aria-hidden="true"></span>Hide timezone</label><label class="format-options-switch-row"><span class="format-options-switch" aria-hidden="true"></span>Force leading zeros</label></div></div></div></div>
```
