...
- Source page: https://21st.dev/community/components/shuding/cobe-globe-pulse/default
- Registry URL: https://21st.dev/r/shuding/cobe-globe-pulse
- Author: shuding
- Component slug: cobe-globe-pulse
- Demo slug: default
- Title: cobe-globe-pulse
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/shuding/cobe-globe-pulse with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/shuding__cobe-globe-pulse__default.html
- Local screenshot file: generated-21st-prompts/screenshots/shuding__cobe-globe-pulse__default.png
