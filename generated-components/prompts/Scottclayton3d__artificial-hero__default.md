...
- Source page: https://21st.dev/community/components/Scottclayton3d/artificial-hero/default
- Registry URL: https://21st.dev/r/Scottclayton3d/artificial-hero
- Author: Scottclayton3d
- Component slug: artificial-hero
- Demo slug: default
- Title: artificial-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/Scottclayton3d/artificial-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/Scottclayton3d__artificial-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/Scottclayton3d__artificial-hero__default.png
