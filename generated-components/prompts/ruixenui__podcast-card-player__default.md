...
- Source page: https://21st.dev/community/components/ruixenui/podcast-card-player/default
- Registry URL: https://21st.dev/r/ruixenui/podcast-card-player
- Author: ruixenui
- Component slug: podcast-card-player
- Demo slug: default
- Title: podcast-card-player
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/podcast-card-player with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__podcast-card-player__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__podcast-card-player__default.png
