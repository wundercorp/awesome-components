...
- Source page: https://21st.dev/community/components/lavikatiyar/card-2/default
- Registry URL: https://21st.dev/r/lavikatiyar/card-2
- Author: lavikatiyar
- Component slug: card-2
- Demo slug: default
- Title: card-2
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/lavikatiyar/card-2 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/lavikatiyar__card-2__default.html
- Local screenshot file: generated-21st-prompts/screenshots/lavikatiyar__card-2__default.png
