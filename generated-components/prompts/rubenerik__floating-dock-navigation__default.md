...
- Source page: https://21st.dev/community/components/rubenerik/floating-dock-navigation/default
- Registry URL: https://21st.dev/r/rubenerik/floating-dock-navigation
- Author: rubenerik
- Component slug: floating-dock-navigation
- Demo slug: default
- Title: floating-dock-navigation
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/rubenerik/floating-dock-navigation with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/rubenerik__floating-dock-navigation__default.html
- Local screenshot file: generated-21st-prompts/screenshots/rubenerik__floating-dock-navigation__default.png
