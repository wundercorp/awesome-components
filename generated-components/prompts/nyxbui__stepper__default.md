...
- Source page: https://21st.dev/community/components/nyxbui/stepper/default
- Registry URL: https://21st.dev/r/nyxbui/stepper
- Author: nyxbui
- Component slug: stepper
- Demo slug: default
- Title: stepper
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/nyxbui/stepper with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/nyxbui__stepper__default.html
- Local screenshot file: generated-21st-prompts/screenshots/nyxbui__stepper__default.png
