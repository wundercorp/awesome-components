...
- Source page: https://21st.dev/community/components/hero_ui/heroui-date-picker/disabled
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/hero_ui__heroui-date-picker__disabled.html
- Local screenshot file: generated-21st-prompts/screenshots/hero_ui__heroui-date-picker__disabled.png
...
```html
<div id="root"><div class="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8"><div data-slot="date-picker" class="date-picker w-64" data-rac="" data-disabled="true"><style>
    ...
    </style><span class="label" data-slot="label">Date</span><div data-react-aria-pressable="true" role="group" aria-disabled="true" class="date-input-group date-input-group--full-width date-input-group--primary" data-slot="date-input-group" data-rac=""><div role="presentation" data-react-aria-pressable="true" class="date-input-group__input" data-slot="date-input-group-input" data-rac=""><span data-slot="date-input-group-segment" role="spinbutton" aria-label="month, " aria-disabled="true" contenteditable="false" class="date-input-group__segment" data-rac="">6</span><span data-slot="date-input-group-segment" aria-disabled="true" contenteditable="false" class="date-input-group__segment" data-rac="">/</span><span data-slot="date-input-group-segment" role="spinbutton" aria-label="day, " aria-disabled="true" contenteditable="false" class="date-input-group__segment" data-rac="">1</span><span data-slot="date-input-group-segment" aria-disabled="true" contenteditable="false" class="date-input-group__segment" data-rac="">/</span><span data-slot="date-input-group-segment" role="spinbutton" aria-label="year, " aria-disabled="true" contenteditable="false" class="date-input-group__segment" data-rac="">2026</span></div><input hidden="" readonly="" type="text" value="2026-06-01" name="date"><div class="date-input-group__suffix" data-slot="date-input-group-suffix"><button data-slot="date-picker-trigger" class="date-picker__trigger" data-rac="" type="button" aria-label="Calendar" aria-haspopup="dialog" aria-expanded="false" disabled=""><span aria-hidden="true" class="date-picker__trigger-indicator" data-slot="date-picker-trigger-indicator"><svg aria-hidden="true" aria-label="Calendar icon" fill="none" height="1em" role="presentation" viewBox="0 0 13 14" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M3.75 4.5A.75.75 0 0 1 3 3.75v-.748a1.5 1.5 0 0 0-1.5 1.5v1h10v-1a1.5 1.5 0 0 0-1.5-1.5v.75a.75.75 0 1 1-1.5 0v-.75h-4v.747a.75.75 0 0 1-.75.75ZM8.5 1.501h-4V.75a.75.75 0 0 0-1.5 0v.752a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h7a3 3 0 0 0 3-3v-6a3 3 0 0 0-3-3v-.75a.75.75 0 0 0-1.5 0v.75Zm-7 5.5v3.5a1.5 1.5 0 0 0 1.5 1.5h7a1.5 1.5 0 0 0 1.5-1.5v-3.5h-10Z" fill="currentColor" fill-rule="evenodd"></path></svg></span></button></div></div><span class="description" data-slot="description" slot="description">This date picker is disabled.</span></div></div></div>
```
