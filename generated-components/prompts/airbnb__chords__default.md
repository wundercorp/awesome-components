...
- Source page: https://21st.dev/community/components/airbnb/chords/default
- Registry URL: https://21st.dev/r/airbnb/chords
- Author: airbnb
- Component slug: chords
- Demo slug: default
- Title: chords
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/airbnb/chords with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/airbnb__chords__default.html
- Local screenshot file: generated-21st-prompts/screenshots/airbnb__chords__default.png
