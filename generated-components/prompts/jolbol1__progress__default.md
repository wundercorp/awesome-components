...
- Source page: https://21st.dev/community/components/jolbol1/progress/default
- Registry URL: https://21st.dev/r/jolbol1/progress
- Author: jolbol1
- Component slug: progress
- Demo slug: default
- Title: progress
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jolbol1/progress with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jolbol1__progress__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jolbol1__progress__default.png
