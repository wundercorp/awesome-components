...
- Source page: https://21st.dev/community/components/dhiluxui/woven-light-hero/default
- Registry URL: https://21st.dev/r/dhiluxui/woven-light-hero
- Author: dhiluxui
- Component slug: woven-light-hero
- Demo slug: default
- Title: woven-light-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/dhiluxui/woven-light-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/dhiluxui__woven-light-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/dhiluxui__woven-light-hero__default.png
