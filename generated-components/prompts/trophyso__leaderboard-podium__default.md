...
- Source page: https://21st.dev/community/components/trophyso/leaderboard-podium/default
- Registry URL: https://21st.dev/r/trophyso/leaderboard-podium
- Author: trophyso
- Component slug: leaderboard-podium
- Demo slug: default
- Title: leaderboard-podium
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/trophyso/leaderboard-podium with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/trophyso__leaderboard-podium__default.html
- Local screenshot file: generated-21st-prompts/screenshots/trophyso__leaderboard-podium__default.png
