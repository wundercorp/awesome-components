...
- Source page: https://21st.dev/community/components/UmairXD/share-button/default
- Registry URL: https://21st.dev/r/UmairXD/share-button
- Author: UmairXD
- Component slug: share-button
- Demo slug: default
- Title: share-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/UmairXD/share-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/UmairXD__share-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/UmairXD__share-button__default.png
