...
- Source page: https://21st.dev/community/components/abishek1512/login-1/default
- Registry URL: https://21st.dev/r/abishek1512/login-1
- Author: abishek1512
- Component slug: login-1
- Demo slug: default
- Title: login-1
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/abishek1512/login-1 with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/abishek1512__login-1__default.html
- Local screenshot file: generated-21st-prompts/screenshots/abishek1512__login-1__default.png
