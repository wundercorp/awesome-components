...
- Source page: https://21st.dev/community/components/jatin-yadav05/notch-nav/default
- Registry URL: https://21st.dev/r/jatin-yadav05/notch-nav
- Author: jatin-yadav05
- Component slug: notch-nav
- Demo slug: default
- Title: notch-nav
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jatin-yadav05/notch-nav with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jatin-yadav05__notch-nav__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jatin-yadav05__notch-nav__default.png
