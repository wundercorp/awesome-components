...
- Source page: https://21st.dev/community/components/jshguo/interfaces-input-otp/default
- Registry URL: https://21st.dev/r/jshguo/interfaces-input-otp
- Author: jshguo
- Component slug: interfaces-input-otp
- Demo slug: default
- Title: interfaces-input-otp
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/jshguo/interfaces-input-otp with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/jshguo__interfaces-input-otp__default.html
- Local screenshot file: generated-21st-prompts/screenshots/jshguo__interfaces-input-otp__default.png
