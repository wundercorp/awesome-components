...
- Source page: https://21st.dev/community/components/thanh/waitlist-hero/default
- Registry URL: https://21st.dev/r/thanh/waitlist-hero
- Author: thanh
- Component slug: waitlist-hero
- Demo slug: default
- Title: waitlist-hero
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/thanh/waitlist-hero with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/thanh__waitlist-hero__default.html
- Local screenshot file: generated-21st-prompts/screenshots/thanh__waitlist-hero__default.png
