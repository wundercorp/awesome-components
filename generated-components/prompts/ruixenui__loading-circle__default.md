...
- Source page: https://21st.dev/community/components/ruixenui/loading-circle/default
- Registry URL: https://21st.dev/r/ruixenui/loading-circle
- Author: ruixenui
- Component slug: loading-circle
- Demo slug: default
- Title: loading-circle
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/loading-circle with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__loading-circle__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__loading-circle__default.png
