...
- Source page: https://21st.dev/community/components/ruixenui/icon-label-subtext-button/default
- Registry URL: https://21st.dev/r/ruixenui/icon-label-subtext-button
- Author: ruixenui
- Component slug: icon-label-subtext-button
- Demo slug: default
- Title: icon-label-subtext-button
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ruixenui/icon-label-subtext-button with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ruixenui__icon-label-subtext-button__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ruixenui__icon-label-subtext-button__default.png
