...
- Source page: https://21st.dev/community/components/uniquesonu/liquid-glass-boxes/default
- Registry URL: https://21st.dev/r/uniquesonu/liquid-glass-boxes
- Author: uniquesonu
- Component slug: liquid-glass-boxes
- Demo slug: default
- Title: liquid-glass-boxes
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/uniquesonu/liquid-glass-boxes with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/uniquesonu__liquid-glass-boxes__default.html
- Local screenshot file: generated-21st-prompts/screenshots/uniquesonu__liquid-glass-boxes__default.png
