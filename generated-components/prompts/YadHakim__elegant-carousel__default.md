...
- Source page: https://21st.dev/community/components/YadHakim/elegant-carousel/default
- Registry URL: https://21st.dev/r/YadHakim/elegant-carousel
- Author: YadHakim
- Component slug: elegant-carousel
- Demo slug: default
- Title: elegant-carousel
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/YadHakim/elegant-carousel with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/YadHakim__elegant-carousel__default.html
- Local screenshot file: generated-21st-prompts/screenshots/YadHakim__elegant-carousel__default.png
