...
- Source page: https://21st.dev/community/components/badtzx0/cursor-cards/default
- Registry URL: https://21st.dev/r/badtzx0/cursor-cards
- Author: badtzx0
- Component slug: cursor-cards
- Demo slug: default
- Title: cursor-cards
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/badtzx0/cursor-cards with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/badtzx0__cursor-cards__default.html
- Local screenshot file: generated-21st-prompts/screenshots/badtzx0__cursor-cards__default.png
