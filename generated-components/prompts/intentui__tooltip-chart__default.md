...
- Source page: https://21st.dev/community/components/intentui/tooltip-chart/default
- Registry URL: https://21st.dev/r/intentui/tooltip-chart
- Author: intentui
- Component slug: tooltip-chart
- Demo slug: default
- Title: tooltip-chart
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/intentui/tooltip-chart with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/intentui__tooltip-chart__default.html
- Local screenshot file: generated-21st-prompts/screenshots/intentui__tooltip-chart__default.png
