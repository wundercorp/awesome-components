...
- Source page: https://21st.dev/community/components/edwinvakayil/breadcrumbs/default
- Registry URL: https://21st.dev/r/edwinvakayil/breadcrumbs
- Author: edwinvakayil
- Component slug: breadcrumbs
- Demo slug: default
- Title: breadcrumbs
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/breadcrumbs with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__breadcrumbs__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__breadcrumbs__default.png
