...
- Source page: https://21st.dev/community/components/edwinvakayil/theme-toggle/default
- Registry URL: https://21st.dev/r/edwinvakayil/theme-toggle
- Author: edwinvakayil
- Component slug: theme-toggle
- Demo slug: default
- Title: theme-toggle
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/edwinvakayil/theme-toggle with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/edwinvakayil__theme-toggle__default.html
- Local screenshot file: generated-21st-prompts/screenshots/edwinvakayil__theme-toggle__default.png
