...
- Source page: https://21st.dev/community/components/ui-layouts/image-reveal/default
- Registry URL: https://21st.dev/r/ui-layouts/image-reveal
- Author: ui-layouts
- Component slug: image-reveal
- Demo slug: default
- Title: image-reveal
- Description: 
- Registry status: Registry fetch failed from https://21st.dev/r/ui-layouts/image-reveal with status 403. Error: {"error":"Authentication required"}
- Local rendered HTML file: generated-21st-prompts/rendered-html/ui-layouts__image-reveal__default.html
- Local screenshot file: generated-21st-prompts/screenshots/ui-layouts__image-reveal__default.png
