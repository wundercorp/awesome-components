...
- Source page: https://21st.dev/community/components/reui/select/disabled-option
- Registry URL: https://21st.dev/r/reui/select
- Author: reui
- Component slug: select
- Demo slug: disabled-option
- Title: select
- Description: 
...
- Local rendered HTML file: generated-21st-prompts/rendered-html/reui__select__disabled-option.html
- Local screenshot file: generated-21st-prompts/screenshots/reui__select__disabled-option.png
